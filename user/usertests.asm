...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      14:	6e0080e7          	jalr	1760(ra) # 56f0 <open>
    if(fd >= 0){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      26:	6ce080e7          	jalr	1742(ra) # 56f0 <open>
    uint64 addr = addrs[ai];
      2a:	55fd                	li	a1,-1
    if(fd >= 0){
    ...
    uint64 addr = addrs[ai];
      ...
      54:	660080e7          	jalr	1632(ra) # 56b0 <exit>
      ...
      74:	8082                	ret
{
      ...
      96:	61e080e7          	jalr	1566(ra) # 56b0 <exit>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      b4:	640080e7          	jalr	1600(ra) # 56f0 <open>
  if(fd < 0){
      b8:	02054663          	bltz	a0,e4 <opentest+0x4a>
  close(fd);
      bc:	00005097          	auipc	ra,0x5
      c0:	61c080e7          	jalr	1564(ra) # 56d8 <close>
  fd = open("doesnotexist", 0);
      c4:	4581                	li	a1,0
      c6:	00006517          	auipc	a0,0x6
      ca:	e9a50513          	addi	a0,a0,-358 # 5f60 <malloc+0x472>
      ce:	00005097          	auipc	ra,0x5
      d2:	622080e7          	jalr	1570(ra) # 56f0 <open>
  if(fd >= 0){
    ...
    exit(1);
      ...
      fc:	5b8080e7          	jalr	1464(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     118:	59c080e7          	jalr	1436(ra) # 56b0 <exit>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     138:	5cc080e7          	jalr	1484(ra) # 5700 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	e5850513          	addi	a0,a0,-424 # 5f98 <malloc+0x4aa>
     148:	00005097          	auipc	ra,0x5
     14c:	5a8080e7          	jalr	1448(ra) # 56f0 <open>
     150:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     152:	4611                	li	a2,4
     ...
     160:	574080e7          	jalr	1396(ra) # 56d0 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	e3050513          	addi	a0,a0,-464 # 5f98 <malloc+0x4aa>
     170:	00005097          	auipc	ra,0x5
     174:	580080e7          	jalr	1408(ra) # 56f0 <open>
     178:	892a                	mv	s2,a0
  int n = write(fd1, "x", 1);
     17a:	4605                	li	a2,1
     ...
     18a:	54a080e7          	jalr	1354(ra) # 56d0 <write>
  if(n != -1){
     18e:	57fd                	li	a5,-1
  ...
  unlink("truncfile");
     ...
     1a0:	564080e7          	jalr	1380(ra) # 5700 <unlink>
  close(fd1);
     1a4:	8526                	mv	a0,s1
     1a6:	00005097          	auipc	ra,0x5
     1aa:	532080e7          	jalr	1330(ra) # 56d8 <close>
  close(fd2);
     1ae:	854a                	mv	a0,s2
     1b0:	00005097          	auipc	ra,0x5
     1b4:	528080e7          	jalr	1320(ra) # 56d8 <close>
}
    ...
    exit(1);
     ...
     1e0:	4d4080e7          	jalr	1236(ra) # 56b0 <exit>
...
00000000000001e4 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     214:	4e0080e7          	jalr	1248(ra) # 56f0 <open>
    close(fd);
     218:	00005097          	auipc	ra,0x5
     21c:	4c0080e7          	jalr	1216(ra) # 56d8 <close>
  for(i = 0; i < N; i++){
  ...
  for(i = 0; i < N; i++){
    ...
    unlink(name);
     ...
     24a:	4ba080e7          	jalr	1210(ra) # 5700 <unlink>
  for(i = 0; i < N; i++){
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     288:	47c080e7          	jalr	1148(ra) # 5700 <unlink>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	444080e7          	jalr	1092(ra) # 56f0 <open>
     2b4:	892a                	mv	s2,a0
    if(fd < 0){
     ...
     2c2:	412080e7          	jalr	1042(ra) # 56d0 <write>
     2c6:	89aa                	mv	s3,a0
      if(cc != sz){
     ...
     2d6:	3fe080e7          	jalr	1022(ra) # 56d0 <write>
      if(cc != sz){
     2da:	04951963          	bne	a0,s1,32c <bigwrite+0xc8>
    close(fd);
     2de:	854a                	mv	a0,s2
     2e0:	00005097          	auipc	ra,0x5
     2e4:	3f8080e7          	jalr	1016(ra) # 56d8 <close>
    unlink("bigwrite");
     2e8:	8556                	mv	a0,s5
     2ea:	00005097          	auipc	ra,0x5
     2ee:	416080e7          	jalr	1046(ra) # 5700 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     328:	38c080e7          	jalr	908(ra) # 56b0 <exit>
     32c:	84ce                	mv	s1,s3
      int cc = write(fd, buf, sz);
     32e:	89aa                	mv	s3,a0
     ...
     34c:	368080e7          	jalr	872(ra) # 56b0 <exit>
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     388:	36c080e7          	jalr	876(ra) # 56f0 <open>
     38c:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     434:	280080e7          	jalr	640(ra) # 56b0 <exit>
     ...
     452:	262080e7          	jalr	610(ra) # 56b0 <exit>
     ...
     470:	244080e7          	jalr	580(ra) # 56b0 <exit>
      printf("pipe() failed\n");
     ...
     48a:	22a080e7          	jalr	554(ra) # 56b0 <exit>
     ...
     4a8:	20c080e7          	jalr	524(ra) # 56b0 <exit>
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4ec:	208080e7          	jalr	520(ra) # 56f0 <open>
     4f0:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     52c:	1a8080e7          	jalr	424(ra) # 56d0 <write>
    if(n != 1){
     530:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     594:	120080e7          	jalr	288(ra) # 56b0 <exit>
     ...
     5b2:	102080e7          	jalr	258(ra) # 56b0 <exit>
      printf("pipe() failed\n");
     ...
     5cc:	0e8080e7          	jalr	232(ra) # 56b0 <exit>
     ...
     5e6:	0ce080e7          	jalr	206(ra) # 56b0 <exit>
     ...
     604:	0b0080e7          	jalr	176(ra) # 56b0 <exit>
...
0000000000000608 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     628:	0dc080e7          	jalr	220(ra) # 5700 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     63c:	0b8080e7          	jalr	184(ra) # 56f0 <open>
     640:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     642:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     698:	05c080e7          	jalr	92(ra) # 56f0 <open>
     69c:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     6d4:	ff8080e7          	jalr	-8(ra) # 56c8 <read>
     6d8:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     716:	fb6080e7          	jalr	-74(ra) # 56c8 <read>
  if(n != 2){
     71a:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     72c:	fd8080e7          	jalr	-40(ra) # 5700 <unlink>
  close(fd1);
     730:	854e                	mv	a0,s3
     732:	00005097          	auipc	ra,0x5
     736:	fa6080e7          	jalr	-90(ra) # 56d8 <close>
  close(fd2);
     73a:	8526                	mv	a0,s1
     73c:	00005097          	auipc	ra,0x5
     740:	f9c080e7          	jalr	-100(ra) # 56d8 <close>
  close(fd3);
     744:	854a                	mv	a0,s2
     746:	00005097          	auipc	ra,0x5
     74a:	f92080e7          	jalr	-110(ra) # 56d8 <close>
}
    ...
    exit(1);
     ...
     77a:	f3a080e7          	jalr	-198(ra) # 56b0 <exit>
    printf("aaa fd3=%d\n", fd3);
     77e:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     7aa:	f0a080e7          	jalr	-246(ra) # 56b0 <exit>
    printf("bbb fd2=%d\n", fd2);
     7ae:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     7da:	eda080e7          	jalr	-294(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     7f8:	ebc080e7          	jalr	-324(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     816:	e9e080e7          	jalr	-354(ra) # 56b0 <exit>
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     840:	eb4080e7          	jalr	-332(ra) # 56f0 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     86a:	e6a080e7          	jalr	-406(ra) # 56d0 <write>
     86e:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     87e:	e56080e7          	jalr	-426(ra) # 56d0 <write>
     882:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	2e458593          	addi	a1,a1,740 # bb98 <buf>
     8bc:	00005097          	auipc	ra,0x5
     8c0:	e0c080e7          	jalr	-500(ra) # 56c8 <read>
  if(i != N*SZ*2){
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     916:	d9e080e7          	jalr	-610(ra) # 56b0 <exit>
     ...
     934:	d80080e7          	jalr	-640(ra) # 56b0 <exit>
     ...
     952:	d62080e7          	jalr	-670(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     96e:	d46080e7          	jalr	-698(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     98a:	d2a080e7          	jalr	-726(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     9a6:	d0e080e7          	jalr	-754(ra) # 56b0 <exit>
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9ce:	d26080e7          	jalr	-730(ra) # 56f0 <open>
     9d2:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     9d4:	4481                	li	s1,0
    ((int*)buf)[0] = i;
     9d6:	0000b917          	auipc	s2,0xb
     9da:	1c290913          	addi	s2,s2,450 # bb98 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     9f6:	cde080e7          	jalr	-802(ra) # 56d0 <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     a40:	c8c080e7          	jalr	-884(ra) # 56c8 <read>
    if(i == 0){
    ...
    exit(1);
     ...
     a72:	c42080e7          	jalr	-958(ra) # 56b0 <exit>
     ...
     a90:	c24080e7          	jalr	-988(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     aac:	c08080e7          	jalr	-1016(ra) # 56b0 <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     b04:	bb0080e7          	jalr	-1104(ra) # 56b0 <exit>
     ...
     b22:	b92080e7          	jalr	-1134(ra) # 56b0 <exit>
     ...
     b40:	b74080e7          	jalr	-1164(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     b5c:	b58080e7          	jalr	-1192(ra) # 56b0 <exit>
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b80:	b74080e7          	jalr	-1164(ra) # 56f0 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     bca:	b3a080e7          	jalr	-1222(ra) # 5700 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     be0:	b14080e7          	jalr	-1260(ra) # 56f0 <open>
     be4:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     be6:	460d                	li	a2,3
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     c86:	a2e080e7          	jalr	-1490(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     ca2:	a12080e7          	jalr	-1518(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     cbe:	9f6080e7          	jalr	-1546(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     cda:	9da080e7          	jalr	-1574(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     cf6:	9be080e7          	jalr	-1602(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     d12:	9a2080e7          	jalr	-1630(ra) # 56b0 <exit>
...
0000000000000d16 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     d54:	9a0080e7          	jalr	-1632(ra) # 56f0 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d6c:	968080e7          	jalr	-1688(ra) # 56d0 <write>
     d70:	4795                	li	a5,5
     d72:	10f51863          	bne	a0,a5,e82 <linktest+0x16c>
  close(fd);
     d76:	8526                	mv	a0,s1
     d78:	00005097          	auipc	ra,0x5
     d7c:	960080e7          	jalr	-1696(ra) # 56d8 <close>
  if(link("lf1", "lf2") < 0){
     ...
     d94:	980080e7          	jalr	-1664(ra) # 5710 <link>
  ...
  fd = open("lf2", 0);
     ...
     dd0:	924080e7          	jalr	-1756(ra) # 56f0 <open>
     dd4:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     e1e:	8e6080e7          	jalr	-1818(ra) # 5700 <unlink>
  if(link("lf2", "lf1") >= 0){
     ...
     e36:	8de080e7          	jalr	-1826(ra) # 5710 <link>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e52:	8c2080e7          	jalr	-1854(ra) # 5710 <link>
    ...
    exit(1);
     ...
     e7e:	836080e7          	jalr	-1994(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     e9a:	81a080e7          	jalr	-2022(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     eb6:	7fe080e7          	jalr	2046(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     ed2:	7e2080e7          	jalr	2018(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     eee:	7c6080e7          	jalr	1990(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     f0a:	7aa080e7          	jalr	1962(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     f26:	78e080e7          	jalr	1934(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     f42:	772080e7          	jalr	1906(ra) # 56b0 <exit>
    ...
    exit(1);
     ...
     f5e:	756080e7          	jalr	1878(ra) # 56b0 <exit>
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ff2:	722080e7          	jalr	1826(ra) # 5710 <link>
     ff6:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    100c:	6f8080e7          	jalr	1784(ra) # 5700 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    104e:	6b6080e7          	jalr	1718(ra) # 5700 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    1086:	62e080e7          	jalr	1582(ra) # 56b0 <exit>
    ...
    10a6:	60e080e7          	jalr	1550(ra) # 56b0 <exit>
    ...
    10c2:	5f2080e7          	jalr	1522(ra) # 56b0 <exit>
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10f6:	61e080e7          	jalr	1566(ra) # 5710 <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1130:	584080e7          	jalr	1412(ra) # 56b0 <exit>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	2264b483          	ld	s1,550(s1) # 8368 <__SDATA_BEGIN__>
    114a:	fd840593          	addi	a1,s0,-40
    114e:	8526                	mv	a0,s1
    1150:	00004097          	auipc	ra,0x4
    1154:	598080e7          	jalr	1432(ra) # 56e8 <exec>

  pipe((int*)0xeaeb0b5b00002f5e);
    1158:	8526                	mv	a0,s1
    115a:	00004097          	auipc	ra,0x4
    115e:	566080e7          	jalr	1382(ra) # 56c0 <pipe>

  exit(0);
    1162:	4501                	li	a0,0
    1164:	00004097          	auipc	ra,0x4
    1168:	54c080e7          	jalr	1356(ra) # 56b0 <exit>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x7b8>
  for(int i = 0; i < 50000; i++){
    ...
    11a0:	54c080e7          	jalr	1356(ra) # 56e8 <exec>
  for(int i = 0; i < 50000; i++){
  ...
  exit(0);
    ...
    11ae:	506080e7          	jalr	1286(ra) # 56b0 <exit>
...
00000000000011b2 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    11dc:	528080e7          	jalr	1320(ra) # 5700 <unlink>
  if(ret != -1){
    11e0:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    11f2:	502080e7          	jalr	1282(ra) # 56f0 <open>
  if(fd != -1){
    11f6:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    1206:	50e080e7          	jalr	1294(ra) # 5710 <link>
  if(ret != -1){
    120a:	57fd                	li	a5,-1
  ...
  if(pid == 0){
    ...
    1268:	20078e23          	sb	zero,540(a5) # 9480 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	cfc78793          	addi	a5,a5,-772 # 7f68 <malloc+0x247a>
    ...
    129c:	450080e7          	jalr	1104(ra) # 56e8 <exec>
    if(ret != -1){
    12a0:	57fd                	li	a5,-1
    ...
    12be:	3f6080e7          	jalr	1014(ra) # 56b0 <exit>
    ...
    12de:	3d6080e7          	jalr	982(ra) # 56b0 <exit>
    ...
    12fe:	3b6080e7          	jalr	950(ra) # 56b0 <exit>
    ...
    1320:	394080e7          	jalr	916(ra) # 56b0 <exit>
    ...
    1340:	374080e7          	jalr	884(ra) # 56b0 <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    13a4:	310080e7          	jalr	784(ra) # 56b0 <exit>
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13cc:	328080e7          	jalr	808(ra) # 56f0 <open>
    13d0:	00004097          	auipc	ra,0x4
    13d4:	308080e7          	jalr	776(ra) # 56d8 <close>
  pid = fork();
    13d8:	00004097          	auipc	ra,0x4
    13dc:	2d0080e7          	jalr	720(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    1402:	2f2080e7          	jalr	754(ra) # 56f0 <open>
    1406:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    1414:	2c0080e7          	jalr	704(ra) # 56d0 <write>
      if(n != 10){
    1418:	47a9                	li	a5,10
    ...
    1424:	2b8080e7          	jalr	696(ra) # 56d8 <close>
      fd = open("truncfile", O_RDONLY);
    1428:	4581                	li	a1,0
    142a:	8552                	mv	a0,s4
    142c:	00004097          	auipc	ra,0x4
    1430:	2c4080e7          	jalr	708(ra) # 56f0 <open>
    1434:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1436:	02000613          	li	a2,32
    143a:	f9840593          	addi	a1,s0,-104
    143e:	00004097          	auipc	ra,0x4
    1442:	28a080e7          	jalr	650(ra) # 56c8 <read>
      close(fd);
    1446:	8526                	mv	a0,s1
    1448:	00004097          	auipc	ra,0x4
    144c:	290080e7          	jalr	656(ra) # 56d8 <close>
    for(int i = 0; i < 100; i++){
    ...
    145c:	258080e7          	jalr	600(ra) # 56b0 <exit>
    ...
    1478:	23c080e7          	jalr	572(ra) # 56b0 <exit>
    ...
    1494:	220080e7          	jalr	544(ra) # 56b0 <exit>
    ...
    14b2:	202080e7          	jalr	514(ra) # 56b0 <exit>
    ...
    14d4:	220080e7          	jalr	544(ra) # 56f0 <open>
    14d8:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    14e6:	1ee080e7          	jalr	494(ra) # 56d0 <write>
    if(n != 3){
    14ea:	478d                	li	a5,3
    ...
    14f6:	1e6080e7          	jalr	486(ra) # 56d8 <close>
  for(int i = 0; i < 150; i++){
  ...
  exit(xstatus);
    ...
    1540:	174080e7          	jalr	372(ra) # 56b0 <exit>
    ...
    155e:	156080e7          	jalr	342(ra) # 56b0 <exit>
...
0000000000001562 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1598:	16c080e7          	jalr	364(ra) # 5700 <unlink>
  pid = fork();
    159c:	00004097          	auipc	ra,0x4
    15a0:	10c080e7          	jalr	268(ra) # 56a8 <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    15b2:	12a080e7          	jalr	298(ra) # 56d8 <close>
    ...
    15c6:	12e080e7          	jalr	302(ra) # 56f0 <open>
    if(fd < 0) {
    ...
    15ec:	0c8080e7          	jalr	200(ra) # 56b0 <exit>
     printf("%s: fork failed\n", s);
    15f0:	85ca                	mv	a1,s2
    ...
    1608:	0ac080e7          	jalr	172(ra) # 56b0 <exit>
    ...
    1624:	090080e7          	jalr	144(ra) # 56b0 <exit>
  ...
  if(xstatus != 0)
    ...
    165a:	05a080e7          	jalr	90(ra) # 56b0 <exit>
    ...
    1676:	03e080e7          	jalr	62(ra) # 56b0 <exit>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    169c:	058080e7          	jalr	88(ra) # 56f0 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16ae:	01e080e7          	jalr	30(ra) # 56c8 <read>
    16b2:	4789                	li	a5,2
    ...
    16d0:	fe4080e7          	jalr	-28(ra) # 56b0 <exit>
    printf("%s: open failed\n", s);
    16d4:	85ca                	mv	a1,s2
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1730:	f84080e7          	jalr	-124(ra) # 56b0 <exit>
    exit(0);
    1734:	4501                	li	a0,0
    1736:	00004097          	auipc	ra,0x4
    173a:	f7a080e7          	jalr	-134(ra) # 56b0 <exit>
...
000000000000173e <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    175e:	f66080e7          	jalr	-154(ra) # 56c0 <pipe>
    1762:	ed25                	bnez	a0,17da <pipe1+0x9c>
    1764:	84aa                	mv	s1,a0
  pid = fork();
    1766:	00004097          	auipc	ra,0x4
    176a:	f42080e7          	jalr	-190(ra) # 56a8 <fork>
    176e:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    177e:	f5e080e7          	jalr	-162(ra) # 56d8 <close>
    total = 0;
    1782:	8a26                	mv	s4,s1
    cc = 1;
    1784:	4985                	li	s3,1
    ...
    178a:	412a8a93          	addi	s5,s5,1042 # bb98 <buf>
      if(cc > sizeof(buf))
    ...
    179c:	f30080e7          	jalr	-208(ra) # 56c8 <read>
    17a0:	10a05263          	blez	a0,18a4 <pipe1+0x166>
      for(i = 0; i < n; i++){
    17a4:	0000a717          	auipc	a4,0xa
    17a8:	3f470713          	addi	a4,a4,1012 # bb98 <buf>
    ...
    17f2:	ec2080e7          	jalr	-318(ra) # 56b0 <exit>
    close(fds[0]);
    17f6:	fa842503          	lw	a0,-88(s0)
    17fa:	00004097          	auipc	ra,0x4
    17fe:	ede080e7          	jalr	-290(ra) # 56d8 <close>
    for(n = 0; n < N; n++){
    1802:	0000ab17          	auipc	s6,0xa
    1806:	396b0b13          	addi	s6,s6,918 # bb98 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1840:	e94080e7          	jalr	-364(ra) # 56d0 <write>
    ...
    185c:	e58080e7          	jalr	-424(ra) # 56b0 <exit>
    ...
    1878:	e3c080e7          	jalr	-452(ra) # 56b0 <exit>
    ...
    1906:	dae080e7          	jalr	-594(ra) # 56b0 <exit>
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1926:	d86080e7          	jalr	-634(ra) # 56a8 <fork>
    192a:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    193a:	d82080e7          	jalr	-638(ra) # 56b8 <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1978:	d3c080e7          	jalr	-708(ra) # 56b0 <exit>
    ...
    1994:	d20080e7          	jalr	-736(ra) # 56b0 <exit>
    ...
    19b0:	d04080e7          	jalr	-764(ra) # 56b0 <exit>
      exit(i);
    19b4:	854a                	mv	a0,s2
    19b6:	00004097          	auipc	ra,0x4
    19ba:	cfa080e7          	jalr	-774(ra) # 56b0 <exit>
...
00000000000019be <twochildren>:
{
    ...
    19d4:	cd8080e7          	jalr	-808(ra) # 56a8 <fork>
    if(pid1 < 0){
    ...
    19e2:	cca080e7          	jalr	-822(ra) # 56a8 <fork>
      if(pid2 < 0){
    ...
    19f2:	cca080e7          	jalr	-822(ra) # 56b8 <wait>
        wait(0);
    19f6:	4501                	li	a0,0
    19f8:	00004097          	auipc	ra,0x4
    19fc:	cc0080e7          	jalr	-832(ra) # 56b8 <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1a28:	c8c080e7          	jalr	-884(ra) # 56b0 <exit>
      exit(0);
    1a2c:	00004097          	auipc	ra,0x4
    1a30:	c84080e7          	jalr	-892(ra) # 56b0 <exit>
        printf("%s: fork failed\n", s);
    1a34:	85ca                	mv	a1,s2
    ...
    1a4c:	c68080e7          	jalr	-920(ra) # 56b0 <exit>
        exit(0);
    1a50:	00004097          	auipc	ra,0x4
    1a54:	c60080e7          	jalr	-928(ra) # 56b0 <exit>
...
0000000000001a58 <forkfork>:
{
    ...
    1a68:	c44080e7          	jalr	-956(ra) # 56a8 <fork>
    if(pid < 0){
    ...
    1a76:	c36080e7          	jalr	-970(ra) # 56a8 <fork>
    if(pid < 0){
    ...
    1a88:	c34080e7          	jalr	-972(ra) # 56b8 <wait>
    if(xstatus != 0) {
    ...
    1a9a:	c22080e7          	jalr	-990(ra) # 56b8 <wait>
    if(xstatus != 0) {
    ...
    1ac6:	bee080e7          	jalr	-1042(ra) # 56b0 <exit>
{
    1aca:	0c800493          	li	s1,200
        int pid1 = fork();
    1ace:	00004097          	auipc	ra,0x4
    1ad2:	bda080e7          	jalr	-1062(ra) # 56a8 <fork>
        if(pid1 < 0){
    ...
    1ae2:	bda080e7          	jalr	-1062(ra) # 56b8 <wait>
      for(int j = 0; j < 200; j++){
    ...
    1af0:	bc4080e7          	jalr	-1084(ra) # 56b0 <exit>
          exit(1);
    1af4:	4505                	li	a0,1
    1af6:	00004097          	auipc	ra,0x4
    1afa:	bba080e7          	jalr	-1094(ra) # 56b0 <exit>
          exit(0);
    1afe:	00004097          	auipc	ra,0x4
    1b02:	bb2080e7          	jalr	-1102(ra) # 56b0 <exit>
    ...
    1b1e:	b96080e7          	jalr	-1130(ra) # 56b0 <exit>
...
0000000000001b22 <reparent2>:
{
    ...
    1b34:	b78080e7          	jalr	-1160(ra) # 56a8 <fork>
    if(pid1 < 0){
    ...
    1b44:	b78080e7          	jalr	-1160(ra) # 56b8 <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1b52:	b62080e7          	jalr	-1182(ra) # 56b0 <exit>
      printf("fork failed\n");
    ...
    1b6c:	b48080e7          	jalr	-1208(ra) # 56b0 <exit>
      fork();
    1b70:	00004097          	auipc	ra,0x4
    1b74:	b38080e7          	jalr	-1224(ra) # 56a8 <fork>
      fork();
    1b78:	00004097          	auipc	ra,0x4
    1b7c:	b30080e7          	jalr	-1232(ra) # 56a8 <fork>
      exit(0);
    1b80:	4501                	li	a0,0
    1b82:	00004097          	auipc	ra,0x4
    1b86:	b2e080e7          	jalr	-1234(ra) # 56b0 <exit>
...
0000000000001b8a <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bae:	afe080e7          	jalr	-1282(ra) # 56a8 <fork>
    1bb2:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1bca:	af2080e7          	jalr	-1294(ra) # 56b8 <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c0a:	aaa080e7          	jalr	-1366(ra) # 56b0 <exit>
      name[0] = 'p' + pi;
    ...
    1c36:	a7e080e7          	jalr	-1410(ra) # 56b0 <exit>
      for(i = 0; i < N; i++){
    ...
    1c54:	aa0080e7          	jalr	-1376(ra) # 56f0 <open>
        if(fd < 0){
    1c58:	fc0543e3          	bltz	a0,1c1e <createdelete+0x94>
        close(fd);
    1c5c:	00004097          	auipc	ra,0x4
    1c60:	a7c080e7          	jalr	-1412(ra) # 56d8 <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1c88:	a7c080e7          	jalr	-1412(ra) # 5700 <unlink>
    ...
    1ca8:	a0c080e7          	jalr	-1524(ra) # 56b0 <exit>
      exit(0);
    1cac:	4501                	li	a0,0
    1cae:	00004097          	auipc	ra,0x4
    1cb2:	a02080e7          	jalr	-1534(ra) # 56b0 <exit>
      exit(1);
    1cb6:	4505                	li	a0,1
    1cb8:	00004097          	auipc	ra,0x4
    1cbc:	9f8080e7          	jalr	-1544(ra) # 56b0 <exit>
    ...
    1cdc:	9d8080e7          	jalr	-1576(ra) # 56b0 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1d04:	9f0080e7          	jalr	-1552(ra) # 56f0 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1d1c:	9c0080e7          	jalr	-1600(ra) # 56d8 <close>
    ...
    1d42:	972080e7          	jalr	-1678(ra) # 56b0 <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1d7c:	988080e7          	jalr	-1656(ra) # 5700 <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd8:	92c080e7          	jalr	-1748(ra) # 5700 <unlink>
  pid = fork();
    1ddc:	00004097          	auipc	ra,0x4
    1de0:	8cc080e7          	jalr	-1844(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e32:	882080e7          	jalr	-1918(ra) # 56b0 <exit>
      close(open("x", O_RDWR | O_CREATE));
    1e36:	20200593          	li	a1,514
    1e3a:	8556                	mv	a0,s5
    1e3c:	00004097          	auipc	ra,0x4
    1e40:	8b4080e7          	jalr	-1868(ra) # 56f0 <open>
    1e44:	00004097          	auipc	ra,0x4
    1e48:	894080e7          	jalr	-1900(ra) # 56d8 <close>
  for(i = 0; i < 100; i++){
    ...
    1e6c:	898080e7          	jalr	-1896(ra) # 5700 <unlink>
    1e70:	bff1                	j	1e4c <linkunlink+0x9c>
      link("cat", "x");
    1e72:	85d6                	mv	a1,s5
    1e74:	855e                	mv	a0,s7
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	89a080e7          	jalr	-1894(ra) # 5710 <link>
  ...
  if(pid)
    ...
    1e8a:	832080e7          	jalr	-1998(ra) # 56b8 <wait>
}
    ...
    1eae:	806080e7          	jalr	-2042(ra) # 56b0 <exit>
...
0000000000001eb2 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ed2:	7da080e7          	jalr	2010(ra) # 56a8 <fork>
    1ed6:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    1ef2:	7ca080e7          	jalr	1994(ra) # 56b8 <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    1f06:	7ae080e7          	jalr	1966(ra) # 56b0 <exit>
      printf("fork failed\n");
    ...
    1f20:	794080e7          	jalr	1940(ra) # 56b0 <exit>
      name[0] = 'b';
    ...
    1f40:	7c4080e7          	jalr	1988(ra) # 5700 <unlink>
    1f44:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    1f46:	0000ab17          	auipc	s6,0xa
    1f4a:	c52b0b13          	addi	s6,s6,-942 # bb98 <buf>
    ...
    1f60:	794080e7          	jalr	1940(ra) # 56f0 <open>
    1f64:	892a                	mv	s2,a0
          if(fd < 0){
    ...
    1f72:	762080e7          	jalr	1890(ra) # 56d0 <write>
          if(cc != sz){
    ...
    1f82:	75a080e7          	jalr	1882(ra) # 56d8 <close>
        for(int i = 0; i < ci+1; i++){
    ...
    1f94:	770080e7          	jalr	1904(ra) # 5700 <unlink>
    ...
    1fa6:	75e080e7          	jalr	1886(ra) # 5700 <unlink>
      exit(0);
    1faa:	4501                	li	a0,0
    1fac:	00003097          	auipc	ra,0x3
    1fb0:	704080e7          	jalr	1796(ra) # 56b0 <exit>
    ...
    1fd0:	6e4080e7          	jalr	1764(ra) # 56b0 <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    1fd4:	86aa                	mv	a3,a0
    ...
    1ff0:	6c4080e7          	jalr	1732(ra) # 56b0 <exit>
      exit(st);
    1ff4:	00003097          	auipc	ra,0x3
    1ff8:	6bc080e7          	jalr	1724(ra) # 56b0 <exit>
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2016:	696080e7          	jalr	1686(ra) # 56a8 <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    203e:	676080e7          	jalr	1654(ra) # 56b0 <exit>
      exit(0);
    2042:	00003097          	auipc	ra,0x3
    2046:	66e080e7          	jalr	1646(ra) # 56b0 <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    205e:	65e080e7          	jalr	1630(ra) # 56b8 <wait>
  ...
  if(wait(0) != -1){
    ...
    2070:	64c080e7          	jalr	1612(ra) # 56b8 <wait>
    2074:	57fd                	li	a5,-1
    ...
    20a0:	614080e7          	jalr	1556(ra) # 56b0 <exit>
    ...
    20bc:	5f8080e7          	jalr	1528(ra) # 56b0 <exit>
    ...
    20d8:	5dc080e7          	jalr	1500(ra) # 56b0 <exit>
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x7b8>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e8d8>
    pid = fork();
    2106:	00003097          	auipc	ra,0x3
    210a:	5a2080e7          	jalr	1442(ra) # 56a8 <fork>
    if(pid < 0){
    ...
    211c:	5a0080e7          	jalr	1440(ra) # 56b8 <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2158:	55c080e7          	jalr	1372(ra) # 56b0 <exit>
    ...
    217a:	53a080e7          	jalr	1338(ra) # 56b0 <exit>
      exit(1);
    217e:	4505                	li	a0,1
    2180:	00003097          	auipc	ra,0x3
    2184:	530080e7          	jalr	1328(ra) # 56b0 <exit>
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    21a0:	564080e7          	jalr	1380(ra) # 5700 <unlink>
  pid = fork();
    21a4:	00003097          	auipc	ra,0x3
    21a8:	504080e7          	jalr	1284(ra) # 56a8 <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    21ba:	502080e7          	jalr	1282(ra) # 56b8 <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    21d2:	522080e7          	jalr	1314(ra) # 56f0 <open>
  if(fd < 0){
    21d6:	08054e63          	bltz	a0,2272 <bigargtest+0xea>
  close(fd);
    21da:	00003097          	auipc	ra,0x3
    21de:	4fe080e7          	jalr	1278(ra) # 56d8 <close>
}
    ...
    21f0:	19478793          	addi	a5,a5,404 # 8380 <args.1>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	28468693          	addi	a3,a3,644 # 8478 <args.1+0xf8>
    ...
    2210:	17458593          	addi	a1,a1,372 # 8380 <args.1>
    ...
    2224:	4c8080e7          	jalr	1224(ra) # 56e8 <exec>
    ...
    2238:	4bc080e7          	jalr	1212(ra) # 56f0 <open>
    close(fd);
    223c:	00003097          	auipc	ra,0x3
    2240:	49c080e7          	jalr	1180(ra) # 56d8 <close>
    exit(0);
    2244:	4501                	li	a0,0
    2246:	00003097          	auipc	ra,0x3
    224a:	46a080e7          	jalr	1130(ra) # 56b0 <exit>
    ...
    2266:	44e080e7          	jalr	1102(ra) # 56b0 <exit>
    exit(xstatus);
    226a:	00003097          	auipc	ra,0x3
    226e:	446080e7          	jalr	1094(ra) # 56b0 <exit>
    ...
    228a:	42a080e7          	jalr	1066(ra) # 56b0 <exit>
...
000000000000228e <stacktest>:
{
  ...
  pid = fork();
    ...
    229e:	40e080e7          	jalr	1038(ra) # 56a8 <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    22b0:	40c080e7          	jalr	1036(ra) # 56b8 <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    22c2:	3f2080e7          	jalr	1010(ra) # 56b0 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22cc:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0458>
    22d0:	85a6                	mv	a1,s1
    ...
    22e8:	3cc080e7          	jalr	972(ra) # 56b0 <exit>
    printf("%s: fork failed\n", s);
    22ec:	85a6                	mv	a1,s1
    ...
    2304:	3b0080e7          	jalr	944(ra) # 56b0 <exit>
    exit(0);
    2308:	4501                	li	a0,0
    230a:	00003097          	auipc	ra,0x3
    230e:	3a6080e7          	jalr	934(ra) # 56b0 <exit>
...
0000000000002312 <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    2322:	41a080e7          	jalr	1050(ra) # 5738 <sbrk>
  uint64 top = (uint64) sbrk(0);
    2326:	4501                	li	a0,0
    2328:	00003097          	auipc	ra,0x3
    232c:	410080e7          	jalr	1040(ra) # 5738 <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    233c:	400080e7          	jalr	1024(ra) # 5738 <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2358:	3ac080e7          	jalr	940(ra) # 5700 <unlink>
  if(ret != -1){
    235c:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    236c:	388080e7          	jalr	904(ra) # 56f0 <open>
  if(fd != -1){
    2370:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    237e:	396080e7          	jalr	918(ra) # 5710 <link>
  if(ret != -1){
    2382:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    23a2:	34a080e7          	jalr	842(ra) # 56e8 <exec>
  if(ret != -1){
    23a6:	57fd                	li	a5,-1
    ...
    23c4:	378080e7          	jalr	888(ra) # 5738 <sbrk>
    ...
    23e0:	2d4080e7          	jalr	724(ra) # 56b0 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    23e4:	862a                	mv	a2,a0
    23e6:	85a6                	mv	a1,s1
    ...
    23fe:	2b6080e7          	jalr	694(ra) # 56b0 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    2402:	862a                	mv	a2,a0
    2404:	85a6                	mv	a1,s1
    ...
    241c:	298080e7          	jalr	664(ra) # 56b0 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    2420:	86aa                	mv	a3,a0
    2422:	8626                	mv	a2,s1
    2424:	85a6                	mv	a1,s1
    ...
    243c:	278080e7          	jalr	632(ra) # 56b0 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    2440:	567d                	li	a2,-1
    2442:	85a6                	mv	a1,s1
    ...
    245a:	25a080e7          	jalr	602(ra) # 56b0 <exit>
...
000000000000245e <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    2470:	2cc080e7          	jalr	716(ra) # 5738 <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    2482:	2ba080e7          	jalr	698(ra) # 5738 <sbrk>
    2486:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    249c:	258080e7          	jalr	600(ra) # 56f0 <open>
    24a0:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    24b6:	21e080e7          	jalr	542(ra) # 56d0 <write>
    24ba:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    24d8:	1dc080e7          	jalr	476(ra) # 56b0 <exit>
    ...
    24f2:	1c2080e7          	jalr	450(ra) # 56b0 <exit>
    ...
    250c:	1a8080e7          	jalr	424(ra) # 56b0 <exit>
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    2564:	168080e7          	jalr	360(ra) # 56c8 <read>
    2568:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    2586:	12e080e7          	jalr	302(ra) # 56b0 <exit>
    printf("open(rwsbrk) failed\n");
    ...
    25a0:	114080e7          	jalr	276(ra) # 56b0 <exit>
  close(fd);
    25a4:	854a                	mv	a0,s2
    25a6:	00003097          	auipc	ra,0x3
    25aa:	132080e7          	jalr	306(ra) # 56d8 <close>
  exit(0);
    25ae:	4501                	li	a0,0
    25b0:	00003097          	auipc	ra,0x3
    25b4:	100080e7          	jalr	256(ra) # 56b0 <exit>
...
00000000000025b8 <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    25ce:	0de080e7          	jalr	222(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    25e0:	15c080e7          	jalr	348(ra) # 5738 <sbrk>
    ...
    25f4:	6705                	lui	a4,0x1
      *b = 99;
    25f6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1458>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2606:	0ae080e7          	jalr	174(ra) # 56b0 <exit>
    ...
    2620:	094080e7          	jalr	148(ra) # 56b0 <exit>
      exit(0);
    2624:	4501                	li	a0,0
    2626:	00003097          	auipc	ra,0x3
    262a:	08a080e7          	jalr	138(ra) # 56b0 <exit>
  wait(&xstatus);
    262e:	fcc40513          	addi	a0,s0,-52
    2632:	00003097          	auipc	ra,0x3
    2636:	086080e7          	jalr	134(ra) # 56b8 <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    264a:	0f2080e7          	jalr	242(ra) # 5738 <sbrk>
    264e:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    2650:	4901                	li	s2,0
    ...
    2672:	042080e7          	jalr	66(ra) # 56b0 <exit>
    a = b + 1;
    2676:	84be                	mv	s1,a5
    b = sbrk(1);
    2678:	4505                	li	a0,1
    267a:	00003097          	auipc	ra,0x3
    267e:	0be080e7          	jalr	190(ra) # 5738 <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    269a:	012080e7          	jalr	18(ra) # 56a8 <fork>
    269e:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    26aa:	092080e7          	jalr	146(ra) # 5738 <sbrk>
  c = sbrk(1);
    26ae:	4505                	li	a0,1
    26b0:	00003097          	auipc	ra,0x3
    26b4:	088080e7          	jalr	136(ra) # 5738 <sbrk>
  if(c != a + 1){
    ...
    26d6:	fde080e7          	jalr	-34(ra) # 56b0 <exit>
    ...
    26f6:	fbe080e7          	jalr	-66(ra) # 56b0 <exit>
...
000000000000273c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    279e:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1457>
  a = sbrk(0);
    27a2:	4501                	li	a0,0
    27a4:	00003097          	auipc	ra,0x3
    27a8:	f94080e7          	jalr	-108(ra) # 5738 <sbrk>
    27ac:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    27ae:	757d                	lui	a0,0xfffff
    27b0:	00003097          	auipc	ra,0x3
    27b4:	f88080e7          	jalr	-120(ra) # 5738 <sbrk>
  ...
  c = sbrk(0);
    ...
    27c4:	f78080e7          	jalr	-136(ra) # 5738 <sbrk>
  if(c != a - PGSIZE){
  ...
  if(c != a){
    ...
    285c:	e58080e7          	jalr	-424(ra) # 56b0 <exit>
    ...
    2878:	e3c080e7          	jalr	-452(ra) # 56b0 <exit>
    ...
    2898:	e1c080e7          	jalr	-484(ra) # 56b0 <exit>
    ...
    28b8:	dfc080e7          	jalr	-516(ra) # 56b0 <exit>
    ...
    28d4:	de0080e7          	jalr	-544(ra) # 56b0 <exit>
    ...
    28f4:	dc0080e7          	jalr	-576(ra) # 56b0 <exit>
...
00000000000028f8 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    290e:	e2e080e7          	jalr	-466(ra) # 5738 <sbrk>
    2912:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    2948:	d8c080e7          	jalr	-628(ra) # 56d0 <write>
    294c:	04054663          	bltz	a0,2998 <sbrkarg+0xa0>
  close(fd);
    2950:	8526                	mv	a0,s1
    2952:	00003097          	auipc	ra,0x3
    2956:	d86080e7          	jalr	-634(ra) # 56d8 <close>
  a = sbrk(PGSIZE);
    295a:	6505                	lui	a0,0x1
    295c:	00003097          	auipc	ra,0x3
    2960:	ddc080e7          	jalr	-548(ra) # 5738 <sbrk>
  if(pipe((int *) a) != 0){
    2964:	00003097          	auipc	ra,0x3
    2968:	d5c080e7          	jalr	-676(ra) # 56c0 <pipe>
    ...
    2994:	d20080e7          	jalr	-736(ra) # 56b0 <exit>
    ...
    29b0:	d04080e7          	jalr	-764(ra) # 56b0 <exit>
    printf("%s: pipe() failed\n", s);
    29b4:	85ce                	mv	a1,s3
    ...
    29cc:	ce8080e7          	jalr	-792(ra) # 56b0 <exit>
...
00000000000029d0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29ec:	d08080e7          	jalr	-760(ra) # 56f0 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    29fc:	d40080e7          	jalr	-704(ra) # 5738 <sbrk>
    2a00:	567d                	li	a2,-1
    2a02:	fff50593          	addi	a1,a0,-1
    2a06:	8526                	mv	a0,s1
    2a08:	00003097          	auipc	ra,0x3
    2a0c:	cc0080e7          	jalr	-832(ra) # 56c8 <read>
  close(fd);
    2a10:	8526                	mv	a0,s1
    2a12:	00003097          	auipc	ra,0x3
    2a16:	cc6080e7          	jalr	-826(ra) # 56d8 <close>
}
    ...
    2a3e:	c76080e7          	jalr	-906(ra) # 56b0 <exit>
...
0000000000002a42 <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2a4e:	c5e080e7          	jalr	-930(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2a5c:	ce0080e7          	jalr	-800(ra) # 5738 <sbrk>
    sbrk(-sz);
    2a60:	40a0053b          	negw	a0,a0
    2a64:	00003097          	auipc	ra,0x3
    2a68:	cd4080e7          	jalr	-812(ra) # 5738 <sbrk>
    exit(0);
    2a6c:	4501                	li	a0,0
    2a6e:	00003097          	auipc	ra,0x3
    2a72:	c42080e7          	jalr	-958(ra) # 56b0 <exit>
    printf("fork failed\n");
    ...
    2a8c:	c28080e7          	jalr	-984(ra) # 56b0 <exit>
  wait(0);
    2a90:	4501                	li	a0,0
    2a92:	00003097          	auipc	ra,0x3
    2a96:	c26080e7          	jalr	-986(ra) # 56b8 <wait>
  pid = fork();
    2a9a:	00003097          	auipc	ra,0x3
    2a9e:	c0e080e7          	jalr	-1010(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2ae2:	bd2080e7          	jalr	-1070(ra) # 56b0 <exit>
  wait(0);
    2ae6:	4501                	li	a0,0
    2ae8:	00003097          	auipc	ra,0x3
    2aec:	bd0080e7          	jalr	-1072(ra) # 56b8 <wait>
  pid = fork();
    2af0:	00003097          	auipc	ra,0x3
    2af4:	bb8080e7          	jalr	-1096(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2b42:	b72080e7          	jalr	-1166(ra) # 56b0 <exit>
  wait(0);
    2b46:	4501                	li	a0,0
    2b48:	00003097          	auipc	ra,0x3
    2b4c:	b70080e7          	jalr	-1168(ra) # 56b8 <wait>
  exit(0);
    2b50:	4501                	li	a0,0
    2b52:	00003097          	auipc	ra,0x3
    2b56:	b5e080e7          	jalr	-1186(ra) # 56b0 <exit>
...
execout(char *s)
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2b72:	b3a080e7          	jalr	-1222(ra) # 56a8 <fork>
    2b76:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2b84:	b38080e7          	jalr	-1224(ra) # 56b8 <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2b94:	b20080e7          	jalr	-1248(ra) # 56b0 <exit>
      printf("fork failed\n");
    ...
    2bae:	b06080e7          	jalr	-1274(ra) # 56b0 <exit>
        if(a == 0xffffffffffffffffLL)
    2bb2:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2bb4:	4a05                	li	s4,1
    ...
    2bbc:	b80080e7          	jalr	-1152(ra) # 5738 <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2bd8:	b64080e7          	jalr	-1180(ra) # 5738 <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2be8:	af4080e7          	jalr	-1292(ra) # 56d8 <close>
      char *args[] = { "echo", "x", 0 };
    ...
    2c10:	adc080e7          	jalr	-1316(ra) # 56e8 <exec>
      exit(0);
    2c14:	4501                	li	a0,0
    2c16:	00003097          	auipc	ra,0x3
    2c1a:	a9a080e7          	jalr	-1382(ra) # 56b0 <exit>
...
0000000000002c1e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c36:	ae6080e7          	jalr	-1306(ra) # 5718 <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c48:	ad4080e7          	jalr	-1324(ra) # 5718 <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2caa:	a72080e7          	jalr	-1422(ra) # 5718 <mkdir>
  ...
  unlink("12345678901234");
    ...
    2d32:	982080e7          	jalr	-1662(ra) # 56b0 <exit>
    ...
    2d4e:	966080e7          	jalr	-1690(ra) # 56b0 <exit>
    ...
    2d6a:	94a080e7          	jalr	-1718(ra) # 56b0 <exit>
    ...
    2d86:	92e080e7          	jalr	-1746(ra) # 56b0 <exit>
    ...
    2da2:	912080e7          	jalr	-1774(ra) # 56b0 <exit>
    ...
    2dbe:	8f6080e7          	jalr	-1802(ra) # 56b0 <exit>
...
0000000000002dc2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dda:	942080e7          	jalr	-1726(ra) # 5718 <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    2dee:	936080e7          	jalr	-1738(ra) # 5720 <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2e02:	902080e7          	jalr	-1790(ra) # 5700 <unlink>
  ...
  if(chdir("/") < 0){
    ...
    2e16:	90e080e7          	jalr	-1778(ra) # 5720 <chdir>
    ...
    2e40:	874080e7          	jalr	-1932(ra) # 56b0 <exit>
    ...
    2e5c:	858080e7          	jalr	-1960(ra) # 56b0 <exit>
    ...
    2e78:	83c080e7          	jalr	-1988(ra) # 56b0 <exit>
    ...
    2e94:	820080e7          	jalr	-2016(ra) # 56b0 <exit>
...
0000000000002e98 <exitiputtest>:
{
  ...
  pid = fork();
    ...
    2ea8:	804080e7          	jalr	-2044(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2ebe:	85e080e7          	jalr	-1954(ra) # 5718 <mkdir>
    ...
    2ed2:	852080e7          	jalr	-1966(ra) # 5720 <chdir>
    ...
    2ee6:	81e080e7          	jalr	-2018(ra) # 5700 <unlink>
    2eea:	06054163          	bltz	a0,2f4c <exitiputtest+0xb4>
    exit(0);
    2eee:	4501                	li	a0,0
    2ef0:	00002097          	auipc	ra,0x2
    2ef4:	7c0080e7          	jalr	1984(ra) # 56b0 <exit>
    printf("%s: fork failed\n", s);
    2ef8:	85a6                	mv	a1,s1
    ...
    2f10:	7a4080e7          	jalr	1956(ra) # 56b0 <exit>
      printf("%s: mkdir failed\n", s);
    2f14:	85a6                	mv	a1,s1
    ...
    2f2c:	788080e7          	jalr	1928(ra) # 56b0 <exit>
    ...
    2f48:	76c080e7          	jalr	1900(ra) # 56b0 <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    2f4c:	85a6                	mv	a1,s1
    ...
    2f64:	750080e7          	jalr	1872(ra) # 56b0 <exit>
  wait(&xstatus);
    2f68:	fdc40513          	addi	a0,s0,-36
    2f6c:	00002097          	auipc	ra,0x2
    2f70:	74c080e7          	jalr	1868(ra) # 56b8 <wait>
  exit(xstatus);
    2f74:	fdc42503          	lw	a0,-36(s0)
    2f78:	00002097          	auipc	ra,0x2
    2f7c:	738080e7          	jalr	1848(ra) # 56b0 <exit>
...
0000000000002f80 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f98:	784080e7          	jalr	1924(ra) # 5718 <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    2fac:	778080e7          	jalr	1912(ra) # 5720 <chdir>
  ...
  if(chdir("..") < 0){
    ...
    2fc0:	764080e7          	jalr	1892(ra) # 5720 <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    2fd4:	730080e7          	jalr	1840(ra) # 5700 <unlink>
    ...
    2ffe:	6b6080e7          	jalr	1718(ra) # 56b0 <exit>
    ...
    301a:	69a080e7          	jalr	1690(ra) # 56b0 <exit>
    printf("%s: chdir .. failed\n", s);
    301e:	85a6                	mv	a1,s1
    ...
    3036:	67e080e7          	jalr	1662(ra) # 56b0 <exit>
    ...
    3052:	662080e7          	jalr	1634(ra) # 56b0 <exit>
...
0000000000003056 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3098:	65c080e7          	jalr	1628(ra) # 56f0 <open>
    309c:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30de:	63e080e7          	jalr	1598(ra) # 5718 <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30f6:	5fe080e7          	jalr	1534(ra) # 56f0 <open>
    30fa:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    317a:	59a080e7          	jalr	1434(ra) # 5710 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    318e:	576080e7          	jalr	1398(ra) # 5700 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    31a4:	550080e7          	jalr	1360(ra) # 56f0 <open>
  ...
  if(chdir("dd") != 0){
    ...
    31b8:	56c080e7          	jalr	1388(ra) # 5720 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31cc:	558080e7          	jalr	1368(ra) # 5720 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31e0:	544080e7          	jalr	1348(ra) # 5720 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    31f4:	530080e7          	jalr	1328(ra) # 5720 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    320a:	4ea080e7          	jalr	1258(ra) # 56f0 <open>
    320e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    325c:	498080e7          	jalr	1176(ra) # 56f0 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3274:	480080e7          	jalr	1152(ra) # 56f0 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    328c:	468080e7          	jalr	1128(ra) # 56f0 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    32a2:	452080e7          	jalr	1106(ra) # 56f0 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b8:	43c080e7          	jalr	1084(ra) # 56f0 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32d4:	440080e7          	jalr	1088(ra) # 5710 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32f0:	424080e7          	jalr	1060(ra) # 5710 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    330c:	408080e7          	jalr	1032(ra) # 5710 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3320:	3fc080e7          	jalr	1020(ra) # 5718 <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3334:	3e8080e7          	jalr	1000(ra) # 5718 <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3348:	3d4080e7          	jalr	980(ra) # 5718 <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    335c:	3a8080e7          	jalr	936(ra) # 5700 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3370:	394080e7          	jalr	916(ra) # 5700 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3384:	3a0080e7          	jalr	928(ra) # 5720 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3398:	38c080e7          	jalr	908(ra) # 5720 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33ac:	358080e7          	jalr	856(ra) # 5700 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33c0:	344080e7          	jalr	836(ra) # 5700 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    33d4:	330080e7          	jalr	816(ra) # 5700 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e8:	31c080e7          	jalr	796(ra) # 5700 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    33fc:	308080e7          	jalr	776(ra) # 5700 <unlink>
    ...
    3428:	28c080e7          	jalr	652(ra) # 56b0 <exit>
    ...
    3444:	270080e7          	jalr	624(ra) # 56b0 <exit>
    ...
    3460:	254080e7          	jalr	596(ra) # 56b0 <exit>
    ...
    347c:	238080e7          	jalr	568(ra) # 56b0 <exit>
    ...
    3498:	21c080e7          	jalr	540(ra) # 56b0 <exit>
    ...
    34b4:	200080e7          	jalr	512(ra) # 56b0 <exit>
    ...
    34d0:	1e4080e7          	jalr	484(ra) # 56b0 <exit>
    ...
    34ec:	1c8080e7          	jalr	456(ra) # 56b0 <exit>
    ...
    3508:	1ac080e7          	jalr	428(ra) # 56b0 <exit>
    ...
    3524:	190080e7          	jalr	400(ra) # 56b0 <exit>
    ...
    3540:	174080e7          	jalr	372(ra) # 56b0 <exit>
    ...
    355c:	158080e7          	jalr	344(ra) # 56b0 <exit>
    ...
    3578:	13c080e7          	jalr	316(ra) # 56b0 <exit>
    printf("%s: chdir ./.. failed\n", s);
    357c:	85ca                	mv	a1,s2
    ...
    3594:	120080e7          	jalr	288(ra) # 56b0 <exit>
    ...
    35b0:	104080e7          	jalr	260(ra) # 56b0 <exit>
    ...
    35cc:	0e8080e7          	jalr	232(ra) # 56b0 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    35d0:	85ca                	mv	a1,s2
    ...
    35e8:	0cc080e7          	jalr	204(ra) # 56b0 <exit>
    ...
    3604:	0b0080e7          	jalr	176(ra) # 56b0 <exit>
    ...
    3620:	094080e7          	jalr	148(ra) # 56b0 <exit>
    ...
    363c:	078080e7          	jalr	120(ra) # 56b0 <exit>
    ...
    3658:	05c080e7          	jalr	92(ra) # 56b0 <exit>
    ...
    3674:	040080e7          	jalr	64(ra) # 56b0 <exit>
    ...
    3690:	024080e7          	jalr	36(ra) # 56b0 <exit>
    ...
    36ac:	008080e7          	jalr	8(ra) # 56b0 <exit>
    ...
    36c8:	fec080e7          	jalr	-20(ra) # 56b0 <exit>
    ...
    36e4:	fd0080e7          	jalr	-48(ra) # 56b0 <exit>
    ...
    3700:	fb4080e7          	jalr	-76(ra) # 56b0 <exit>
    ...
    371c:	f98080e7          	jalr	-104(ra) # 56b0 <exit>
    ...
    3738:	f7c080e7          	jalr	-132(ra) # 56b0 <exit>
    ...
    3754:	f60080e7          	jalr	-160(ra) # 56b0 <exit>
    ...
    3770:	f44080e7          	jalr	-188(ra) # 56b0 <exit>
    ...
    378c:	f28080e7          	jalr	-216(ra) # 56b0 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3790:	85ca                	mv	a1,s2
    ...
    37a8:	f0c080e7          	jalr	-244(ra) # 56b0 <exit>
    ...
    37c4:	ef0080e7          	jalr	-272(ra) # 56b0 <exit>
    ...
    37e0:	ed4080e7          	jalr	-300(ra) # 56b0 <exit>
    ...
    37fc:	eb8080e7          	jalr	-328(ra) # 56b0 <exit>
    ...
    3818:	e9c080e7          	jalr	-356(ra) # 56b0 <exit>
...
000000000000381c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3834:	ee8080e7          	jalr	-280(ra) # 5718 <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    3846:	ede080e7          	jalr	-290(ra) # 5720 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3858:	eac080e7          	jalr	-340(ra) # 5700 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    386a:	e9a080e7          	jalr	-358(ra) # 5700 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    387c:	ea8080e7          	jalr	-344(ra) # 5720 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    388e:	e76080e7          	jalr	-394(ra) # 5700 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    38a0:	e64080e7          	jalr	-412(ra) # 5700 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    38b2:	e52080e7          	jalr	-430(ra) # 5700 <unlink>
    ...
    38da:	dda080e7          	jalr	-550(ra) # 56b0 <exit>
    ...
    38f6:	dbe080e7          	jalr	-578(ra) # 56b0 <exit>
    printf("%s: rm . worked!\n", s);
    38fa:	85a6                	mv	a1,s1
    ...
    3912:	da2080e7          	jalr	-606(ra) # 56b0 <exit>
    printf("%s: rm .. worked!\n", s);
    3916:	85a6                	mv	a1,s1
    ...
    392e:	d86080e7          	jalr	-634(ra) # 56b0 <exit>
    printf("%s: chdir / failed\n", s);
    3932:	85a6                	mv	a1,s1
    ...
    394a:	d6a080e7          	jalr	-662(ra) # 56b0 <exit>
    ...
    3966:	d4e080e7          	jalr	-690(ra) # 56b0 <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    396a:	85a6                	mv	a1,s1
    ...
    3982:	d32080e7          	jalr	-718(ra) # 56b0 <exit>
    ...
    399e:	d16080e7          	jalr	-746(ra) # 56b0 <exit>
...
00000000000039a2 <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    39f0:	d04080e7          	jalr	-764(ra) # 56f0 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a08:	cec080e7          	jalr	-788(ra) # 56f0 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a1c:	d00080e7          	jalr	-768(ra) # 5718 <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a30:	cd4080e7          	jalr	-812(ra) # 5700 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a4c:	cc8080e7          	jalr	-824(ra) # 5710 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a60:	ca4080e7          	jalr	-860(ra) # 5700 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    3a76:	c7e080e7          	jalr	-898(ra) # 56f0 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    3a8c:	c68080e7          	jalr	-920(ra) # 56f0 <open>
    3a90:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    3a92:	4605                	li	a2,1
    ...
    3aa0:	c34080e7          	jalr	-972(ra) # 56d0 <write>
    3aa4:	10a04b63          	bgtz	a0,3bba <dirfile+0x218>
  close(fd);
    3aa8:	8526                	mv	a0,s1
    3aaa:	00002097          	auipc	ra,0x2
    3aae:	c2e080e7          	jalr	-978(ra) # 56d8 <close>
}
    ...
    3ad6:	bde080e7          	jalr	-1058(ra) # 56b0 <exit>
    ...
    3af2:	bc2080e7          	jalr	-1086(ra) # 56b0 <exit>
    ...
    3b0e:	ba6080e7          	jalr	-1114(ra) # 56b0 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    3b12:	85ca                	mv	a1,s2
    ...
    3b2a:	b8a080e7          	jalr	-1142(ra) # 56b0 <exit>
    ...
    3b46:	b6e080e7          	jalr	-1170(ra) # 56b0 <exit>
    ...
    3b62:	b52080e7          	jalr	-1198(ra) # 56b0 <exit>
    ...
    3b7e:	b36080e7          	jalr	-1226(ra) # 56b0 <exit>
    ...
    3b9a:	b1a080e7          	jalr	-1254(ra) # 56b0 <exit>
    ...
    3bb6:	afe080e7          	jalr	-1282(ra) # 56b0 <exit>
    ...
    3bd2:	ae2080e7          	jalr	-1310(ra) # 56b0 <exit>
...
0000000000003bd6 <iref>:
{
    ...
    3c2a:	a8a080e7          	jalr	-1398(ra) # 56b0 <exit>
    ...
    3c46:	a6e080e7          	jalr	-1426(ra) # 56b0 <exit>
      close(fd);
    3c4a:	00002097          	auipc	ra,0x2
    3c4e:	a8e080e7          	jalr	-1394(ra) # 56d8 <close>
    3c52:	a889                	j	3ca4 <iref+0xce>
    unlink("xx");
    3c54:	854e                	mv	a0,s3
    3c56:	00002097          	auipc	ra,0x2
    3c5a:	aaa080e7          	jalr	-1366(ra) # 5700 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cae:	a46080e7          	jalr	-1466(ra) # 56f0 <open>
    if(fd >= 0)
    3cb2:	fa0541e3          	bltz	a0,3c54 <iref+0x7e>
      close(fd);
    3cb6:	00002097          	auipc	ra,0x2
    3cba:	a22080e7          	jalr	-1502(ra) # 56d8 <close>
    ...
    3cda:	a4a080e7          	jalr	-1462(ra) # 5720 <chdir>
    unlink("irefd");
    3cde:	854a                	mv	a0,s2
    3ce0:	00002097          	auipc	ra,0x2
    3ce4:	a20080e7          	jalr	-1504(ra) # 5700 <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    3cf8:	a2c080e7          	jalr	-1492(ra) # 5720 <chdir>
}
...
0000000000003d10 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d28:	9f4080e7          	jalr	-1548(ra) # 5718 <mkdir>
    3d2c:	04054263          	bltz	a0,3d70 <openiputtest+0x60>
  pid = fork();
    3d30:	00002097          	auipc	ra,0x2
    3d34:	978080e7          	jalr	-1672(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    3d4c:	9a8080e7          	jalr	-1624(ra) # 56f0 <open>
    if(fd >= 0){
    ...
    3d6c:	948080e7          	jalr	-1720(ra) # 56b0 <exit>
    ...
    3d88:	92c080e7          	jalr	-1748(ra) # 56b0 <exit>
    printf("%s: fork failed\n", s);
    3d8c:	85a6                	mv	a1,s1
  ...
  if(unlink("oidir") != 0){
    ...
    3de6:	8ce080e7          	jalr	-1842(ra) # 56b0 <exit>
  wait(&xstatus);
    3dea:	fdc40513          	addi	a0,s0,-36
    3dee:	00002097          	auipc	ra,0x2
    3df2:	8ca080e7          	jalr	-1846(ra) # 56b8 <wait>
  exit(xstatus);
    3df6:	fdc42503          	lw	a0,-36(s0)
    3dfa:	00002097          	auipc	ra,0x2
    3dfe:	8b6080e7          	jalr	-1866(ra) # 56b0 <exit>
...
0000000000003e02 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e1a:	8ea080e7          	jalr	-1814(ra) # 5700 <unlink>
  int pid = fork();
    3e1e:	00002097          	auipc	ra,0x2
    3e22:	88a080e7          	jalr	-1910(ra) # 56a8 <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    ...
    3e32:	912080e7          	jalr	-1774(ra) # 5740 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e46:	8ae080e7          	jalr	-1874(ra) # 56f0 <open>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	88e080e7          	jalr	-1906(ra) # 56d8 <close>
  wait(0);
    3e52:	4501                	li	a0,0
    3e54:	00002097          	auipc	ra,0x2
    3e58:	864080e7          	jalr	-1948(ra) # 56b8 <wait>
  sleep(10); // one second
    3e5c:	4529                	li	a0,10
    3e5e:	00002097          	auipc	ra,0x2
    3e62:	8e2080e7          	jalr	-1822(ra) # 5740 <sleep>
}
    ...
    3e88:	82c080e7          	jalr	-2004(ra) # 56b0 <exit>
...
0000000000003ed2 <killstatus>:
{
    ...
    3eee:	7be080e7          	jalr	1982(ra) # 56a8 <fork>
    3ef2:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    3f00:	844080e7          	jalr	-1980(ra) # 5740 <sleep>
    kill(pid1);
    3f04:	8526                	mv	a0,s1
    3f06:	00001097          	auipc	ra,0x1
    3f0a:	7da080e7          	jalr	2010(ra) # 56e0 <kill>
    wait(&xst);
    3f0e:	fcc40513          	addi	a0,s0,-52
    3f12:	00001097          	auipc	ra,0x1
    3f16:	7a6080e7          	jalr	1958(ra) # 56b8 <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    3f2e:	786080e7          	jalr	1926(ra) # 56b0 <exit>
      printf("%s: fork failed\n", s);
    3f32:	85d2                	mv	a1,s4
    ...
    3f4a:	76a080e7          	jalr	1898(ra) # 56b0 <exit>
        getpid();
    3f4e:	00001097          	auipc	ra,0x1
    3f52:	7e2080e7          	jalr	2018(ra) # 5730 <getpid>
      while(1) {
    ...
    3f70:	744080e7          	jalr	1860(ra) # 56b0 <exit>
...
0000000000003f74 <preempt>:
{
  ...
  pid1 = fork();
    ...
    3f8a:	722080e7          	jalr	1826(ra) # 56a8 <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    3fb0:	704080e7          	jalr	1796(ra) # 56b0 <exit>
  pid2 = fork();
    3fb4:	00001097          	auipc	ra,0x1
    3fb8:	6f4080e7          	jalr	1780(ra) # 56a8 <fork>
    3fbc:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    3fde:	6d6080e7          	jalr	1750(ra) # 56b0 <exit>
  pipe(pfds);
    3fe2:	fc840513          	addi	a0,s0,-56
    3fe6:	00001097          	auipc	ra,0x1
    3fea:	6da080e7          	jalr	1754(ra) # 56c0 <pipe>
  pid3 = fork();
    3fee:	00001097          	auipc	ra,0x1
    3ff2:	6ba080e7          	jalr	1722(ra) # 56a8 <fork>
    3ff6:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    4006:	6d6080e7          	jalr	1750(ra) # 56d8 <close>
    ...
    404c:	668080e7          	jalr	1640(ra) # 56b0 <exit>
  ...
  close(pfds[1]);
    ...
    406c:	670080e7          	jalr	1648(ra) # 56d8 <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    4070:	660d                	lui	a2,0x3
    4072:	00008597          	auipc	a1,0x8
    4076:	b2658593          	addi	a1,a1,-1242 # bb98 <buf>
    407a:	fc842503          	lw	a0,-56(s0)
    407e:	00001097          	auipc	ra,0x1
    4082:	64a080e7          	jalr	1610(ra) # 56c8 <read>
    4086:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    40b6:	626080e7          	jalr	1574(ra) # 56d8 <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    40d0:	614080e7          	jalr	1556(ra) # 56e0 <kill>
  kill(pid2);
    40d4:	854e                	mv	a0,s3
    40d6:	00001097          	auipc	ra,0x1
    40da:	60a080e7          	jalr	1546(ra) # 56e0 <kill>
  kill(pid3);
    40de:	8552                	mv	a0,s4
    40e0:	00001097          	auipc	ra,0x1
    40e4:	600080e7          	jalr	1536(ra) # 56e0 <kill>
  printf("wait... ");
  ...
  wait(0);
    ...
    40fe:	5be080e7          	jalr	1470(ra) # 56b8 <wait>
  wait(0);
    4102:	4501                	li	a0,0
    4104:	00001097          	auipc	ra,0x1
    4108:	5b4080e7          	jalr	1460(ra) # 56b8 <wait>
  wait(0);
    410c:	4501                	li	a0,0
    410e:	00001097          	auipc	ra,0x1
    4112:	5aa080e7          	jalr	1450(ra) # 56b8 <wait>
...
0000000000004118 <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    412e:	606080e7          	jalr	1542(ra) # 5730 <getpid>
    4132:	8a2a                	mv	s4,a0
    4134:	0c800913          	li	s2,200
    int pid = fork();
    4138:	00001097          	auipc	ra,0x1
    413c:	570080e7          	jalr	1392(ra) # 56a8 <fork>
    4140:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    414e:	56e080e7          	jalr	1390(ra) # 56b8 <wait>
  ...
  exit(0);
    ...
    4162:	552080e7          	jalr	1362(ra) # 56b0 <exit>
      printf("%s: fork failed\n", s);
    4166:	85ce                	mv	a1,s3
    ...
    417e:	536080e7          	jalr	1334(ra) # 56b0 <exit>
        printf("%s: wait wrong pid\n", s);
    4182:	85ce                	mv	a1,s3
    ...
    419a:	51a080e7          	jalr	1306(ra) # 56b0 <exit>
      int pid2 = fork();
    419e:	00001097          	auipc	ra,0x1
    41a2:	50a080e7          	jalr	1290(ra) # 56a8 <fork>
      if(pid2 < 0){
    41a6:	00054763          	bltz	a0,41b4 <reparent+0x9c>
      exit(0);
    41aa:	4501                	li	a0,0
    41ac:	00001097          	auipc	ra,0x1
    41b0:	504080e7          	jalr	1284(ra) # 56b0 <exit>
        kill(master_pid);
    41b4:	8552                	mv	a0,s4
    41b6:	00001097          	auipc	ra,0x1
    41ba:	52a080e7          	jalr	1322(ra) # 56e0 <kill>
        exit(1);
    41be:	4505                	li	a0,1
    41c0:	00001097          	auipc	ra,0x1
    41c4:	4f0080e7          	jalr	1264(ra) # 56b0 <exit>
...
00000000000041c8 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    41e4:	4e0080e7          	jalr	1248(ra) # 56c0 <pipe>
    ...
    423e:	496080e7          	jalr	1174(ra) # 56d0 <write>
      for(;;) sleep(1000);
    4242:	3e800513          	li	a0,1000
    4246:	00001097          	auipc	ra,0x1
    424a:	4fa080e7          	jalr	1274(ra) # 5740 <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    425a:	452080e7          	jalr	1106(ra) # 56a8 <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    429c:	448080e7          	jalr	1096(ra) # 56e0 <kill>
    wait(0);
    42a0:	4501                	li	a0,0
    42a2:	00001097          	auipc	ra,0x1
    42a6:	416080e7          	jalr	1046(ra) # 56b8 <wait>
  ...
  pid = fork();
    ...
    42b6:	3f6080e7          	jalr	1014(ra) # 56a8 <fork>
    42ba:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    42ca:	3f2080e7          	jalr	1010(ra) # 56b8 <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    4308:	3ac080e7          	jalr	940(ra) # 56b0 <exit>
    printf("%s: fork failed\n", s);
    430c:	85d6                	mv	a1,s5
    ...
    4324:	390080e7          	jalr	912(ra) # 56b0 <exit>
    a = sbrk(0);
    4328:	4501                	li	a0,0
    432a:	00001097          	auipc	ra,0x1
    432e:	40e080e7          	jalr	1038(ra) # 5738 <sbrk>
    4332:	892a                	mv	s2,a0
    sbrk(10*BIG);
    4334:	3e800537          	lui	a0,0x3e800
    4338:	00001097          	auipc	ra,0x1
    433c:	400080e7          	jalr	1024(ra) # 5738 <sbrk>
    ...
    4348:	6705                	lui	a4,0x1
      n += *(a+i);
    434a:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1458>
    ...
    4370:	344080e7          	jalr	836(ra) # 56b0 <exit>
    exit(1);
    4374:	4505                	li	a0,1
    4376:	00001097          	auipc	ra,0x1
    437a:	33a080e7          	jalr	826(ra) # 56b0 <exit>
...
000000000000437e <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4392:	31a080e7          	jalr	794(ra) # 56a8 <fork>
    m1 = 0;
    4396:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    43a8:	314080e7          	jalr	788(ra) # 56b8 <wait>
    if(xstatus == -1){
    ...
    43ba:	2fa080e7          	jalr	762(ra) # 56b0 <exit>
      *(char**)m2 = m1;
    ...
    43f8:	2bc080e7          	jalr	700(ra) # 56b0 <exit>
    ...
    4414:	2a0080e7          	jalr	672(ra) # 56b0 <exit>
      exit(0);
    4418:	4501                	li	a0,0
    441a:	00001097          	auipc	ra,0x1
    441e:	296080e7          	jalr	662(ra) # 56b0 <exit>
...
0000000000004422 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4446:	2be080e7          	jalr	702(ra) # 5700 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    445a:	29a080e7          	jalr	666(ra) # 56f0 <open>
  if(fd < 0){
    445e:	04054a63          	bltz	a0,44b2 <sharedfd+0x90>
    4462:	892a                	mv	s2,a0
  pid = fork();
    4464:	00001097          	auipc	ra,0x1
    4468:	244080e7          	jalr	580(ra) # 56a8 <fork>
    446c:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4482:	036080e7          	jalr	54(ra) # 54b4 <memset>
    ...
    4496:	23e080e7          	jalr	574(ra) # 56d0 <write>
    449a:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    44ae:	206080e7          	jalr	518(ra) # 56b0 <exit>
    ...
    44ca:	1ea080e7          	jalr	490(ra) # 56b0 <exit>
    ...
    44e6:	1ce080e7          	jalr	462(ra) # 56b0 <exit>
    wait(&xstatus);
    44ea:	f9c40513          	addi	a0,s0,-100
    44ee:	00001097          	auipc	ra,0x1
    44f2:	1ca080e7          	jalr	458(ra) # 56b8 <wait>
    if(xstatus != 0)
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4544:	188080e7          	jalr	392(ra) # 56c8 <read>
    ...
    456a:	14a080e7          	jalr	330(ra) # 56b0 <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    45cc:	0e8080e7          	jalr	232(ra) # 56b0 <exit>
    exit(0);
    45d0:	4501                	li	a0,0
    45d2:	00001097          	auipc	ra,0x1
    45d6:	0de080e7          	jalr	222(ra) # 56b0 <exit>
...
00000000000045da <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4640:	0c4080e7          	jalr	196(ra) # 5700 <unlink>
    pid = fork();
    4644:	00001097          	auipc	ra,0x1
    4648:	064080e7          	jalr	100(ra) # 56a8 <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4664:	058080e7          	jalr	88(ra) # 56b8 <wait>
    if(xstatus != 0)
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    467c:	520a0a13          	addi	s4,s4,1312 # bb98 <buf>
    4680:	00007a97          	auipc	s5,0x7
    4684:	519a8a93          	addi	s5,s5,1305 # bb99 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    46ae:	006080e7          	jalr	6(ra) # 56b0 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    46b2:	20200593          	li	a1,514
    46b6:	854e                	mv	a0,s3
    46b8:	00001097          	auipc	ra,0x1
    46bc:	038080e7          	jalr	56(ra) # 56f0 <open>
    46c0:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    46d2:	4ca50513          	addi	a0,a0,1226 # bb98 <buf>
    46d6:	00001097          	auipc	ra,0x1
    46da:	dde080e7          	jalr	-546(ra) # 54b4 <memset>
    46de:	44b1                	li	s1,12
        if((n = write(fd, buf, SZ)) != SZ){
    46e0:	00007997          	auipc	s3,0x7
    46e4:	4b898993          	addi	s3,s3,1208 # bb98 <buf>
    46e8:	1f400613          	li	a2,500
    46ec:	85ce                	mv	a1,s3
    46ee:	854a                	mv	a0,s2
    46f0:	00001097          	auipc	ra,0x1
    46f4:	fe0080e7          	jalr	-32(ra) # 56d0 <write>
    46f8:	85aa                	mv	a1,a0
    ...
    470c:	fa8080e7          	jalr	-88(ra) # 56b0 <exit>
    ...
    472a:	f8a080e7          	jalr	-118(ra) # 56b0 <exit>
    ...
    4744:	f70080e7          	jalr	-144(ra) # 56b0 <exit>
      exit(xstatus);
    4748:	855a                	mv	a0,s6
    474a:	00001097          	auipc	ra,0x1
    474e:	f66080e7          	jalr	-154(ra) # 56b0 <exit>
          printf("wrong char\n", s);
    ...
    476c:	f48080e7          	jalr	-184(ra) # 56b0 <exit>
      total += n;
    ...
    477e:	f4e080e7          	jalr	-178(ra) # 56c8 <read>
    4782:	02a05363          	blez	a0,47a8 <fourfiles+0x1ce>
    4786:	00007797          	auipc	a5,0x7
    478a:	41278793          	addi	a5,a5,1042 # bb98 <buf>
    ...
    47ae:	f2e080e7          	jalr	-210(ra) # 56d8 <close>
    if(total != N*SZ){
    47b2:	03b91863          	bne	s2,s11,47e2 <fourfiles+0x208>
    unlink(fname);
    47b6:	8566                	mv	a0,s9
    47b8:	00001097          	auipc	ra,0x1
    47bc:	f48080e7          	jalr	-184(ra) # 5700 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    47d4:	f20080e7          	jalr	-224(ra) # 56f0 <open>
    47d8:	89aa                	mv	s3,a0
    total = 0;
    47da:	895a                	mv	s2,s6
        if(buf[j] != '0'+i){
    ...
    47fa:	eba080e7          	jalr	-326(ra) # 56b0 <exit>
}
...
000000000000481c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    485e:	eb6080e7          	jalr	-330(ra) # 5710 <link>
    if(pid == 0) {
    ...
    487c:	e78080e7          	jalr	-392(ra) # 56f0 <open>
      if(fd < 0){
    ...
    489e:	e16080e7          	jalr	-490(ra) # 56b0 <exit>
      link("C0", file);
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4908:	dc4080e7          	jalr	-572(ra) # 56c8 <read>
    ...
    496a:	d4a080e7          	jalr	-694(ra) # 56b0 <exit>
    ...
    498a:	d2a080e7          	jalr	-726(ra) # 56b0 <exit>
  close(fd);
    498e:	854a                	mv	a0,s2
    4990:	00001097          	auipc	ra,0x1
    4994:	d48080e7          	jalr	-696(ra) # 56d8 <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    49c2:	cf2080e7          	jalr	-782(ra) # 56b0 <exit>
      printf("%s: fork failed\n", s);
    49c6:	85ce                	mv	a1,s3
  ...
  for(i = 0; i < N; i++){
    ...
    4a86:	c26080e7          	jalr	-986(ra) # 56a8 <fork>
    4a8a:	892a                	mv	s2,a0
    if(pid < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    4b32:	bd2080e7          	jalr	-1070(ra) # 5700 <unlink>
    pid = fork();
    4b36:	00001097          	auipc	ra,0x1
    4b3a:	b72080e7          	jalr	-1166(ra) # 56a8 <fork>
    if(pid && (i % 3) == 1){
    ...
    4b56:	b9e080e7          	jalr	-1122(ra) # 56f0 <open>
      if(fd < 0){
...
0000000000004b76 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    4b96:	b6e080e7          	jalr	-1170(ra) # 5700 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    4baa:	b4a080e7          	jalr	-1206(ra) # 56f0 <open>
    4bae:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    4bb0:	4481                	li	s1,0
    memset(buf, i, SZ);
    4bb2:	00007917          	auipc	s2,0x7
    4bb6:	fe690913          	addi	s2,s2,-26 # bb98 <buf>
  for(i = 0; i < N; i++){
    4bba:	4a51                	li	s4,20
  if(fd < 0){
    ...
    4bcc:	8ec080e7          	jalr	-1812(ra) # 54b4 <memset>
    if(write(fd, buf, SZ) != SZ){
    4bd0:	25800613          	li	a2,600
    4bd4:	85ca                	mv	a1,s2
    4bd6:	854e                	mv	a0,s3
    4bd8:	00001097          	auipc	ra,0x1
    4bdc:	af8080e7          	jalr	-1288(ra) # 56d0 <write>
  ...
  for(i = 0; ; i++){
    ...
    4c14:	f8890913          	addi	s2,s2,-120 # bb98 <buf>
  if(fd < 0){
    ...
    4c28:	aa4080e7          	jalr	-1372(ra) # 56c8 <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    4c74:	a40080e7          	jalr	-1472(ra) # 56b0 <exit>
    ...
    4c90:	a24080e7          	jalr	-1500(ra) # 56b0 <exit>
    ...
    4cac:	a08080e7          	jalr	-1528(ra) # 56b0 <exit>
    ...
    4cc8:	9ec080e7          	jalr	-1556(ra) # 56b0 <exit>
    ...
    4ce4:	9d0080e7          	jalr	-1584(ra) # 56b0 <exit>
    ...
    4d00:	9b4080e7          	jalr	-1612(ra) # 56b0 <exit>
  close(fd);
    4d04:	8552                	mv	a0,s4
    4d06:	00001097          	auipc	ra,0x1
    4d0a:	9d2080e7          	jalr	-1582(ra) # 56d8 <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    4d24:	9e0080e7          	jalr	-1568(ra) # 5700 <unlink>
}
    ...
    4d52:	962080e7          	jalr	-1694(ra) # 56b0 <exit>
...
0000000000004d56 <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4da2:	dfaa0a13          	addi	s4,s4,-518 # bb98 <buf>
    name[0] = 'f';
    ...
    4e00:	8f4080e7          	jalr	-1804(ra) # 56f0 <open>
    4e04:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    4e7a:	88a080e7          	jalr	-1910(ra) # 5700 <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    4ec4:	810080e7          	jalr	-2032(ra) # 56d0 <write>
      if(cc < BSIZE)
    ...
    4eea:	7f2080e7          	jalr	2034(ra) # 56d8 <close>
    if(total == 0)
...
0000000000004ef6 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4f00:	47470713          	addi	a4,a4,1140 # 8370 <randstate>
    4f04:	6308                	ld	a0,0(a4)
    4f06:	001967b7          	lui	a5,0x196
    4f0a:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187a65>
    4f0e:	02f50533          	mul	a0,a0,a5
    4f12:	3c6ef7b7          	lui	a5,0x3c6ef
    4f16:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e07b7>
...
0000000000004f26 <badwrite>:
{
  ...
  unlink("junk");
    ...
    4f42:	7c2080e7          	jalr	1986(ra) # 5700 <unlink>
    ...
    4f62:	792080e7          	jalr	1938(ra) # 56f0 <open>
    4f66:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    4f74:	760080e7          	jalr	1888(ra) # 56d0 <write>
    close(fd);
    4f78:	8526                	mv	a0,s1
    4f7a:	00000097          	auipc	ra,0x0
    4f7e:	75e080e7          	jalr	1886(ra) # 56d8 <close>
    unlink("junk");
    4f82:	854e                	mv	a0,s3
    4f84:	00000097          	auipc	ra,0x0
    4f88:	77c080e7          	jalr	1916(ra) # 5700 <unlink>
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4fa2:	752080e7          	jalr	1874(ra) # 56f0 <open>
    4fa6:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4fba:	71a080e7          	jalr	1818(ra) # 56d0 <write>
    4fbe:	4785                	li	a5,1
    ...
    4fda:	6da080e7          	jalr	1754(ra) # 56b0 <exit>
    ...
    4ff4:	6c0080e7          	jalr	1728(ra) # 56b0 <exit>
    printf("open junk failed\n");
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    504c:	678080e7          	jalr	1656(ra) # 56c0 <pipe>
  ...
  int pid = fork();
    ...
    5058:	654080e7          	jalr	1620(ra) # 56a8 <fork>
  ...
  if(pid == 0){
    ...
    506a:	672080e7          	jalr	1650(ra) # 56d8 <close>
    ...
    5080:	6bc080e7          	jalr	1724(ra) # 5738 <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    509c:	638080e7          	jalr	1592(ra) # 56d0 <write>
    ...
    50ba:	5fa080e7          	jalr	1530(ra) # 56b0 <exit>
    printf("pipe() failed in countfree()\n");
    ...
    50d4:	5e0080e7          	jalr	1504(ra) # 56b0 <exit>
    printf("fork failed in countfree()\n");
    ...
    50ee:	5c6080e7          	jalr	1478(ra) # 56b0 <exit>
      }
    }
    ...
    50f8:	5bc080e7          	jalr	1468(ra) # 56b0 <exit>
  }

  close(fds[1]);
    50fc:	fcc42503          	lw	a0,-52(s0)
    5100:	00000097          	auipc	ra,0x0
    5104:	5d8080e7          	jalr	1496(ra) # 56d8 <close>
  ...
  while(1){
    ...
    5118:	5b4080e7          	jalr	1460(ra) # 56c8 <read>
    if(cc < 0){
  ...
  while(1){
    ...
    513c:	578080e7          	jalr	1400(ra) # 56b0 <exit>
  }

  close(fds[0]);
    5140:	fc842503          	lw	a0,-56(s0)
    5144:	00000097          	auipc	ra,0x0
    5148:	594080e7          	jalr	1428(ra) # 56d8 <close>
  wait((int*)0);
    514c:	4501                	li	a0,0
    514e:	00000097          	auipc	ra,0x0
    5152:	56a080e7          	jalr	1386(ra) # 56b8 <wait>
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    518a:	522080e7          	jalr	1314(ra) # 56a8 <fork>
  ...
  if(pid == 0) {
    ...
    519c:	520080e7          	jalr	1312(ra) # 56b8 <wait>
    if(xstatus != 0) 
    ...
    51e0:	4d4080e7          	jalr	1236(ra) # 56b0 <exit>
    f(s);
    51e4:	854a                	mv	a0,s2
    51e6:	9482                	jalr	s1
    exit(0);
    ...
    51ee:	4c6080e7          	jalr	1222(ra) # 56b0 <exit>
      printf("OK\n");
...
main(int argc, char *argv[])
{
  ...
  printf("in usertests\n");
    ...
    5234:	c3850513          	addi	a0,a0,-968 # 7e68 <malloc+0x237a>
    5238:	00000097          	auipc	ra,0x0
    523c:	7f8080e7          	jalr	2040(ra) # 5a30 <printf>
  int continuous = 0;
  char *justone = 0;

  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    5240:	4789                	li	a5,2
    5242:	08f98763          	beq	s3,a5,52d0 <main+0xcc>
    continuous = 1;
  ...
  char *justone = 0;
    ...
    524a:	0d37c063          	blt	a5,s3,530a <main+0x106>
  }
  ...
  struct test {
    ...
    524e:	00003797          	auipc	a5,0x3
    5252:	d3a78793          	addi	a5,a5,-710 # 7f88 <malloc+0x249a>
    5256:	c0040713          	addi	a4,s0,-1024
    525a:	00003817          	auipc	a6,0x3
    525e:	0ee80813          	addi	a6,a6,238 # 8348 <malloc+0x285a>
    5262:	6388                	ld	a0,0(a5)
    5264:	678c                	ld	a1,8(a5)
    5266:	6b90                	ld	a2,16(a5)
    5268:	6f94                	ld	a3,24(a5)
    526a:	e308                	sd	a0,0(a4)
    526c:	e70c                	sd	a1,8(a4)
    526e:	eb10                	sd	a2,16(a4)
    5270:	ef14                	sd	a3,24(a4)
    5272:	02078793          	addi	a5,a5,32
    5276:	02070713          	addi	a4,a4,32
    527a:	ff0794e3          	bne	a5,a6,5262 <main+0x5e>
          exit(1);
      }
    }
  }
  ...
  printf("usertests starting\n");
    ...
    5282:	caa50513          	addi	a0,a0,-854 # 7f28 <malloc+0x243a>
    5286:	00000097          	auipc	ra,0x0
    528a:	7aa080e7          	jalr	1962(ra) # 5a30 <printf>
  int free0 = countfree();
    528e:	00000097          	auipc	ra,0x0
    5292:	da8080e7          	jalr	-600(ra) # 5036 <countfree>
    5296:	8a2a                	mv	s4,a0
  int free1 = 0;
  int fail = 0;
  for (struct test *t = tests; t->s != 0; t++) {
    5298:	c0843503          	ld	a0,-1016(s0)
    529c:	c0040493          	addi	s1,s0,-1024
  int fail = 0;
    52a0:	4981                	li	s3,0
    ...
    52a2:	4a85                	li	s5,1
  for (struct test *t = tests; t->s != 0; t++) {
    52a4:	e555                	bnez	a0,5350 <main+0x14c>
  }
  ...
  if(fail){
    ...
    52aa:	d90080e7          	jalr	-624(ra) # 5036 <countfree>
    52ae:	85aa                	mv	a1,a0
    52b0:	0f455063          	bge	a0,s4,5390 <main+0x18c>
    printf("FAILED -- lost some free pages %d (out of %d)\n", free1, free0);
    52b4:	8652                	mv	a2,s4
    52b6:	00003517          	auipc	a0,0x3
    52ba:	c2a50513          	addi	a0,a0,-982 # 7ee0 <malloc+0x23f2>
    52be:	00000097          	auipc	ra,0x0
    52c2:	772080e7          	jalr	1906(ra) # 5a30 <printf>
    exit(1);
    52c6:	4505                	li	a0,1
    52c8:	00000097          	auipc	ra,0x0
    52cc:	3e8080e7          	jalr	1000(ra) # 56b0 <exit>
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    52d0:	00003597          	auipc	a1,0x3
    52d4:	ba858593          	addi	a1,a1,-1112 # 7e78 <malloc+0x238a>
    52d8:	6488                	ld	a0,8(s1)
    52da:	00000097          	auipc	ra,0x0
    52de:	184080e7          	jalr	388(ra) # 545e <strcmp>
    52e2:	10050563          	beqz	a0,53ec <main+0x1e8>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    52e6:	00003597          	auipc	a1,0x3
    52ea:	c7a58593          	addi	a1,a1,-902 # 7f60 <malloc+0x2472>
    52ee:	6488                	ld	a0,8(s1)
    52f0:	00000097          	auipc	ra,0x0
    52f4:	16e080e7          	jalr	366(ra) # 545e <strcmp>
    52f8:	c97d                	beqz	a0,53ee <main+0x1ea>
  } else if(argc == 2 && argv[1][0] != '-'){
    52fa:	0084b903          	ld	s2,8(s1)
    52fe:	00094703          	lbu	a4,0(s2)
    5302:	02d00793          	li	a5,45
    5306:	f4f714e3          	bne	a4,a5,524e <main+0x4a>
    printf("Usage: usertests [-c] [testname]\n");
    530a:	00003517          	auipc	a0,0x3
    530e:	b7650513          	addi	a0,a0,-1162 # 7e80 <malloc+0x2392>
    5312:	00000097          	auipc	ra,0x0
    5316:	71e080e7          	jalr	1822(ra) # 5a30 <printf>
    exit(1);
    531a:	4505                	li	a0,1
    531c:	00000097          	auipc	ra,0x0
    5320:	394080e7          	jalr	916(ra) # 56b0 <exit>
          exit(1);
    5324:	4505                	li	a0,1
    5326:	00000097          	auipc	ra,0x0
    532a:	38a080e7          	jalr	906(ra) # 56b0 <exit>
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    532e:	40a905bb          	subw	a1,s2,a0
    5332:	855a                	mv	a0,s6
    5334:	00000097          	auipc	ra,0x0
    5338:	6fc080e7          	jalr	1788(ra) # 5a30 <printf>
        if(continuous != 2)
    533c:	09498463          	beq	s3,s4,53c4 <main+0x1c0>
          exit(1);
    5340:	4505                	li	a0,1
    5342:	00000097          	auipc	ra,0x0
    5346:	36e080e7          	jalr	878(ra) # 56b0 <exit>
  for (struct test *t = tests; t->s != 0; t++) {
    534a:	04c1                	addi	s1,s1,16
    534c:	6488                	ld	a0,8(s1)
    534e:	c115                	beqz	a0,5372 <main+0x16e>
    if((justone == 0) || strcmp(t->s, justone) == 0) {
    5350:	00090863          	beqz	s2,5360 <main+0x15c>
    5354:	85ca                	mv	a1,s2
    5356:	00000097          	auipc	ra,0x0
    535a:	108080e7          	jalr	264(ra) # 545e <strcmp>
    535e:	f575                	bnez	a0,534a <main+0x146>
      if(!run(t->f, t->s))
    5360:	648c                	ld	a1,8(s1)
    5362:	6088                	ld	a0,0(s1)
    5364:	00000097          	auipc	ra,0x0
    5368:	e02080e7          	jalr	-510(ra) # 5166 <run>
    536c:	fd79                	bnez	a0,534a <main+0x146>
        fail = 1;
    536e:	89d6                	mv	s3,s5
    5370:	bfe9                	j	534a <main+0x146>
  if(fail){
    5372:	f2098ae3          	beqz	s3,52a6 <main+0xa2>
    printf("SOME TESTS FAILED\n");
    5376:	00003517          	auipc	a0,0x3
    537a:	b5250513          	addi	a0,a0,-1198 # 7ec8 <malloc+0x23da>
    537e:	00000097          	auipc	ra,0x0
    5382:	6b2080e7          	jalr	1714(ra) # 5a30 <printf>
    exit(1);
    5386:	4505                	li	a0,1
    5388:	00000097          	auipc	ra,0x0
    538c:	328080e7          	jalr	808(ra) # 56b0 <exit>
  } else {
    printf("ALL TESTS PASSED\n");
    5390:	00003517          	auipc	a0,0x3
    5394:	b8050513          	addi	a0,a0,-1152 # 7f10 <malloc+0x2422>
    5398:	00000097          	auipc	ra,0x0
    539c:	698080e7          	jalr	1688(ra) # 5a30 <printf>
    exit(0);
    53a0:	4501                	li	a0,0
    53a2:	00000097          	auipc	ra,0x0
    53a6:	30e080e7          	jalr	782(ra) # 56b0 <exit>
        printf("SOME TESTS FAILED\n");
    53aa:	8556                	mv	a0,s5
    53ac:	00000097          	auipc	ra,0x0
    53b0:	684080e7          	jalr	1668(ra) # 5a30 <printf>
        if(continuous != 2)
    53b4:	f74998e3          	bne	s3,s4,5324 <main+0x120>
      int free1 = countfree();
    53b8:	00000097          	auipc	ra,0x0
    53bc:	c7e080e7          	jalr	-898(ra) # 5036 <countfree>
      if(free1 < free0){
    53c0:	f72547e3          	blt	a0,s2,532e <main+0x12a>
      int free0 = countfree();
    53c4:	00000097          	auipc	ra,0x0
    53c8:	c72080e7          	jalr	-910(ra) # 5036 <countfree>
    53cc:	892a                	mv	s2,a0
      for (struct test *t = tests; t->s != 0; t++) {
    53ce:	c0843583          	ld	a1,-1016(s0)
    53d2:	d1fd                	beqz	a1,53b8 <main+0x1b4>
    53d4:	c0040493          	addi	s1,s0,-1024
        if(!run(t->f, t->s)){
    53d8:	6088                	ld	a0,0(s1)
    53da:	00000097          	auipc	ra,0x0
    53de:	d8c080e7          	jalr	-628(ra) # 5166 <run>
    53e2:	d561                	beqz	a0,53aa <main+0x1a6>
      for (struct test *t = tests; t->s != 0; t++) {
    53e4:	04c1                	addi	s1,s1,16
    53e6:	648c                	ld	a1,8(s1)
    53e8:	f9e5                	bnez	a1,53d8 <main+0x1d4>
    53ea:	b7f9                	j	53b8 <main+0x1b4>
    continuous = 1;
    53ec:	4985                	li	s3,1
  } tests[] = {
    53ee:	00003797          	auipc	a5,0x3
    53f2:	b9a78793          	addi	a5,a5,-1126 # 7f88 <malloc+0x249a>
    53f6:	c0040713          	addi	a4,s0,-1024
    53fa:	00003817          	auipc	a6,0x3
    53fe:	f4e80813          	addi	a6,a6,-178 # 8348 <malloc+0x285a>
    5402:	6388                	ld	a0,0(a5)
    5404:	678c                	ld	a1,8(a5)
    5406:	6b90                	ld	a2,16(a5)
    5408:	6f94                	ld	a3,24(a5)
    540a:	e308                	sd	a0,0(a4)
    540c:	e70c                	sd	a1,8(a4)
    540e:	eb10                	sd	a2,16(a4)
    5410:	ef14                	sd	a3,24(a4)
    5412:	02078793          	addi	a5,a5,32
    5416:	02070713          	addi	a4,a4,32
    541a:	ff0794e3          	bne	a5,a6,5402 <main+0x1fe>
    printf("continuous usertests starting\n");
    541e:	00003517          	auipc	a0,0x3
    5422:	b2250513          	addi	a0,a0,-1246 # 7f40 <malloc+0x2452>
    5426:	00000097          	auipc	ra,0x0
    542a:	60a080e7          	jalr	1546(ra) # 5a30 <printf>
        printf("SOME TESTS FAILED\n");
    542e:	00003a97          	auipc	s5,0x3
    5432:	a9aa8a93          	addi	s5,s5,-1382 # 7ec8 <malloc+0x23da>
        if(continuous != 2)
    5436:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5438:	00003b17          	auipc	s6,0x3
    543c:	a70b0b13          	addi	s6,s6,-1424 # 7ea8 <malloc+0x23ba>
    5440:	b751                	j	53c4 <main+0x1c0>

0000000000005442 <strcpy>:
...
{
    5442:	1141                	addi	sp,sp,-16
    5444:	e422                	sd	s0,8(sp)
    5446:	0800                	addi	s0,sp,16
  char *os;

  os = s;
  while((*s++ = *t++) != 0)
    5448:	87aa                	mv	a5,a0
    544a:	0585                	addi	a1,a1,1
    544c:	0785                	addi	a5,a5,1
    544e:	fff5c703          	lbu	a4,-1(a1)
    5452:	fee78fa3          	sb	a4,-1(a5)
    5456:	fb75                	bnez	a4,544a <strcpy+0x8>
    ;
  return os;
}
...
000000000000545e <strcmp>:

int
strcmp(const char *p, const char *q)
{
    545e:	1141                	addi	sp,sp,-16
    5460:	e422                	sd	s0,8(sp)
    5462:	0800                	addi	s0,sp,16
  while(*p && *p == *q)
    5464:	00054783          	lbu	a5,0(a0)
    5468:	cb91                	beqz	a5,547c <strcmp+0x1e>
    546a:	0005c703          	lbu	a4,0(a1)
    546e:	00f71763          	bne	a4,a5,547c <strcmp+0x1e>
    p++, q++;
    5472:	0505                	addi	a0,a0,1
    5474:	0585                	addi	a1,a1,1
  while(*p && *p == *q)
    5476:	00054783          	lbu	a5,0(a0)
    547a:	fbe5                	bnez	a5,546a <strcmp+0xc>
  return (uchar)*p - (uchar)*q;
    547c:	0005c503          	lbu	a0,0(a1)
}
    5480:	40a7853b          	subw	a0,a5,a0
    5484:	6422                	ld	s0,8(sp)
    5486:	0141                	addi	sp,sp,16
    5488:	8082                	ret

000000000000548a <strlen>:

uint
strlen(const char *s)
{
    548a:	1141                	addi	sp,sp,-16
    548c:	e422                	sd	s0,8(sp)
    548e:	0800                	addi	s0,sp,16
  int n;

  for(n = 0; s[n]; n++)
    5490:	00054783          	lbu	a5,0(a0)
    5494:	cf91                	beqz	a5,54b0 <strlen+0x26>
    5496:	0505                	addi	a0,a0,1
    5498:	87aa                	mv	a5,a0
    549a:	4685                	li	a3,1
    549c:	9e89                	subw	a3,a3,a0
    549e:	00f6853b          	addw	a0,a3,a5
    54a2:	0785                	addi	a5,a5,1
    54a4:	fff7c703          	lbu	a4,-1(a5)
    54a8:	fb7d                	bnez	a4,549e <strlen+0x14>
    ;
  return n;
}
    54aa:	6422                	ld	s0,8(sp)
    54ac:	0141                	addi	sp,sp,16
    54ae:	8082                	ret
  for(n = 0; s[n]; n++)
    54b0:	4501                	li	a0,0
    54b2:	bfe5                	j	54aa <strlen+0x20>

00000000000054b4 <memset>:
...
memset(void *dst, int c, uint n)
{
  ...
  int i;
  for(i = 0; i < n; i++){
    54ba:	ca19                	beqz	a2,54d0 <memset+0x1c>
    54bc:	87aa                	mv	a5,a0
    54be:	1602                	slli	a2,a2,0x20
    54c0:	9201                	srli	a2,a2,0x20
    54c2:	00a60733          	add	a4,a2,a0
    cdst[i] = c;
    54c6:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
    54ca:	0785                	addi	a5,a5,1
    54cc:	fee79de3          	bne	a5,a4,54c6 <memset+0x12>
  }
  return dst;
}
    54d0:	6422                	ld	s0,8(sp)
    54d2:	0141                	addi	sp,sp,16
    54d4:	8082                	ret

00000000000054d6 <strchr>:
...
strchr(const char *s, char c)
{
  ...
  for(; *s; s++)
    ...
    54e0:	cb99                	beqz	a5,54f6 <strchr+0x20>
    if(*s == c)
    54e2:	00f58763          	beq	a1,a5,54f0 <strchr+0x1a>
  for(; *s; s++)
    54e6:	0505                	addi	a0,a0,1
    54e8:	00054783          	lbu	a5,0(a0)
    54ec:	fbfd                	bnez	a5,54e2 <strchr+0xc>
      return (char*)s;
  return 0;
    54ee:	4501                	li	a0,0
}
    54f0:	6422                	ld	s0,8(sp)
    54f2:	0141                	addi	sp,sp,16
    54f4:	8082                	ret
  return 0;
    54f6:	4501                	li	a0,0
    54f8:	bfe5                	j	54f0 <strchr+0x1a>

00000000000054fa <gets>:

char*
gets(char *buf, int max)
{
    54fa:	711d                	addi	sp,sp,-96
    54fc:	ec86                	sd	ra,88(sp)
    54fe:	e8a2                	sd	s0,80(sp)
    5500:	e4a6                	sd	s1,72(sp)
    5502:	e0ca                	sd	s2,64(sp)
    5504:	fc4e                	sd	s3,56(sp)
    5506:	f852                	sd	s4,48(sp)
    5508:	f456                	sd	s5,40(sp)
    550a:	f05a                	sd	s6,32(sp)
    550c:	ec5e                	sd	s7,24(sp)
  ...
  for(i=0; i+1 < max; ){
    ...
    5520:	0344d863          	bge	s1,s4,5550 <gets+0x56>
    cc = read(0, &c, 1);
    5524:	4605                	li	a2,1
    5526:	faf40593          	addi	a1,s0,-81
    552a:	4501                	li	a0,0
    552c:	00000097          	auipc	ra,0x0
    5530:	19c080e7          	jalr	412(ra) # 56c8 <read>
    if(cc < 1)
    5534:	00a05e63          	blez	a0,5550 <gets+0x56>
    buf[i++] = c;
    5538:	faf44783          	lbu	a5,-81(s0)
    553c:	00f90023          	sb	a5,0(s2)
    if(c == '\n' || c == '\r')
    5540:	01578763          	beq	a5,s5,554e <gets+0x54>
    5544:	0905                	addi	s2,s2,1
    5546:	fd679be3          	bne	a5,s6,551c <gets+0x22>
  for(i=0; i+1 < max; ){
    554a:	89a6                	mv	s3,s1
    554c:	a011                	j	5550 <gets+0x56>
    554e:	89a6                	mv	s3,s1
      break;
  }
  buf[i] = '\0';
    5550:	99de                	add	s3,s3,s7
    5552:	00098023          	sb	zero,0(s3)
  return buf;
}
    5556:	855e                	mv	a0,s7
    5558:	60e6                	ld	ra,88(sp)
    555a:	6446                	ld	s0,80(sp)
    555c:	64a6                	ld	s1,72(sp)
    555e:	6906                	ld	s2,64(sp)
    5560:	79e2                	ld	s3,56(sp)
    5562:	7a42                	ld	s4,48(sp)
    5564:	7aa2                	ld	s5,40(sp)
    5566:	7b02                	ld	s6,32(sp)
    5568:	6be2                	ld	s7,24(sp)
...
stat(const char *n, struct stat *st)
{
    ...
    5574:	e426                	sd	s1,8(sp)
    5576:	e04a                	sd	s2,0(sp)
    5578:	1000                	addi	s0,sp,32
    557a:	892e                	mv	s2,a1
  int fd;
  int r;
  ...
  fd = open(n, O_RDONLY);
    ...
    5582:	172080e7          	jalr	370(ra) # 56f0 <open>
  if(fd < 0)
    5586:	02054563          	bltz	a0,55b0 <stat+0x42>
    558a:	84aa                	mv	s1,a0
    return -1;
  r = fstat(fd, st);
    558c:	85ca                	mv	a1,s2
    558e:	00000097          	auipc	ra,0x0
    5592:	17a080e7          	jalr	378(ra) # 5708 <fstat>
    5596:	892a                	mv	s2,a0
  close(fd);
    5598:	8526                	mv	a0,s1
    559a:	00000097          	auipc	ra,0x0
    559e:	13e080e7          	jalr	318(ra) # 56d8 <close>
  return r;
}
    55a2:	854a                	mv	a0,s2
    55a4:	60e2                	ld	ra,24(sp)
    55a6:	6442                	ld	s0,16(sp)
    55a8:	64a2                	ld	s1,8(sp)
    55aa:	6902                	ld	s2,0(sp)
    55ac:	6105                	addi	sp,sp,32
    55ae:	8082                	ret
    return -1;
    55b0:	597d                	li	s2,-1
    55b2:	bfc5                	j	55a2 <stat+0x34>

00000000000055b4 <atoi>:
...
atoi(const char *s)
{
  ...
  n = 0;
  while('0' <= *s && *s <= '9')
    55ba:	00054603          	lbu	a2,0(a0)
    55be:	fd06079b          	addiw	a5,a2,-48
    55c2:	0ff7f793          	andi	a5,a5,255
    55c6:	4725                	li	a4,9
    55c8:	02f76963          	bltu	a4,a5,55fa <atoi+0x46>
    55cc:	86aa                	mv	a3,a0
  n = 0;
    55ce:	4501                	li	a0,0
  while('0' <= *s && *s <= '9')
    55d0:	45a5                	li	a1,9
    n = n*10 + *s++ - '0';
    55d2:	0685                	addi	a3,a3,1
    55d4:	0025179b          	slliw	a5,a0,0x2
    55d8:	9fa9                	addw	a5,a5,a0
    55da:	0017979b          	slliw	a5,a5,0x1
    55de:	9fb1                	addw	a5,a5,a2
    55e0:	fd07851b          	addiw	a0,a5,-48
  while('0' <= *s && *s <= '9')
    55e4:	0006c603          	lbu	a2,0(a3)
    55e8:	fd06071b          	addiw	a4,a2,-48
    55ec:	0ff77713          	andi	a4,a4,255
    55f0:	fee5f1e3          	bgeu	a1,a4,55d2 <atoi+0x1e>
  return n;
}
  ...
  n = 0;
    55fa:	4501                	li	a0,0
    55fc:	bfe5                	j	55f4 <atoi+0x40>

00000000000055fe <memmove>:
...
memmove(void *vdst, const void *vsrc, int n)
{
  ...
  src = vsrc;
  if (src > dst) {
    5604:	02b57463          	bgeu	a0,a1,562c <memmove+0x2e>
    while(n-- > 0)
    5608:	00c05f63          	blez	a2,5626 <memmove+0x28>
  ...
  dst = vdst;
    ...
    while(n-- > 0)
    5622:	fee79ae3          	bne	a5,a4,5616 <memmove+0x18>
    src += n;
    while(n-- > 0)
      *--dst = *--src;
  }
  return vdst;
    ...
    while(n-- > 0)
    5632:	fec05ae3          	blez	a2,5626 <memmove+0x28>
    5636:	fff6079b          	addiw	a5,a2,-1
    563a:	1782                	slli	a5,a5,0x20
    563c:	9381                	srli	a5,a5,0x20
    563e:	fff7c793          	not	a5,a5
    5642:	97ba                	add	a5,a5,a4
      *--dst = *--src;
    5644:	15fd                	addi	a1,a1,-1
    5646:	177d                	addi	a4,a4,-1
    5648:	0005c683          	lbu	a3,0(a1)
    564c:	00d70023          	sb	a3,0(a4)
    while(n-- > 0)
    5650:	fee79ae3          	bne	a5,a4,5644 <memmove+0x46>
    5654:	bfc9                	j	5626 <memmove+0x28>

0000000000005656 <memcmp>:
...
memcmp(const void *s1, const void *s2, uint n)
{
  ...
  while (n-- > 0) {
    565c:	ca05                	beqz	a2,568c <memcmp+0x36>
    565e:	fff6069b          	addiw	a3,a2,-1
    5662:	1682                	slli	a3,a3,0x20
    5664:	9281                	srli	a3,a3,0x20
    5666:	0685                	addi	a3,a3,1
    5668:	96aa                	add	a3,a3,a0
    if (*p1 != *p2) {
    566a:	00054783          	lbu	a5,0(a0)
    566e:	0005c703          	lbu	a4,0(a1)
    5672:	00e79863          	bne	a5,a4,5682 <memcmp+0x2c>
      return *p1 - *p2;
    }
    p1++;
  ...
  while (n-- > 0) {
    567a:	fed518e3          	bne	a0,a3,566a <memcmp+0x14>
  }
  return 0;
    567e:	4501                	li	a0,0
    5680:	a019                	j	5686 <memcmp+0x30>
      return *p1 - *p2;
    5682:	40e7853b          	subw	a0,a5,a4
}
  ...
  return 0;
    568c:	4501                	li	a0,0
    568e:	bfe5                	j	5686 <memcmp+0x30>

0000000000005690 <memcpy>:
...
memcpy(void *dst, const void *src, uint n)
{
  ...
  return memmove(dst, src, n);
    ...
    569c:	f66080e7          	jalr	-154(ra) # 55fe <memmove>
}
    56a0:	60a2                	ld	ra,8(sp)
    56a2:	6402                	ld	s0,0(sp)
    56a4:	0141                	addi	sp,sp,16
    56a6:	8082                	ret

00000000000056a8 <fork>:
...
0000000000005750 <setAndGetPageFaultsNum>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    576e:	f66080e7          	jalr	-154(ra) # 56d0 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    57a0:	bb450513          	addi	a0,a0,-1100 # 8350 <digits>
    57a4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    586c:	ae8b8b93          	addi	s7,s7,-1304 # 8350 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    59ac:	9a090913          	addi	s2,s2,-1632 # 8348 <malloc+0x285a>
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    5a74:	9087b783          	ld	a5,-1784(a5) # 8378 <freep>
    ...
    5aa2:	00e6ea63          	bltu	a3,a4,5ab6 <free+0x50>
{
  ...
  freep = p;
    ...
    5ae4:	88f73c23          	sd	a5,-1896(a4) # 8378 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5b16:	86653503          	ld	a0,-1946(a0) # 8378 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5b3e:	83e90913          	addi	s2,s2,-1986 # 8378 <freep>
  if(p == (char*)-1)
    5b42:	5afd                	li	s5,-1
    5b44:	a895                	j	5bb8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5b46:	00009797          	auipc	a5,0x9
    5b4a:	05278793          	addi	a5,a5,82 # eb98 <base>
    5b4e:	00003717          	auipc	a4,0x3
    5b52:	82f73523          	sd	a5,-2006(a4) # 8378 <freep>
    ...
    5b7a:	80a73123          	sd	a0,-2046(a4) # 8378 <freep>
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5bc8:	b74080e7          	jalr	-1164(ra) # 5738 <sbrk>
  if(p == (char*)-1)
