...
00000000000005ac <setAndGetPageFaultsNum>:
 ...
 8fe:	00e6ea63          	bltu	a3,a4,912 <free+0x50>
{
 ...
 916:	6390                	ld	a2,0(a5)
 918:	02059813          	slli	a6,a1,0x20
 91c:	01c85713          	srli	a4,a6,0x1c
 ...
 926:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
 92a:	4790                	lw	a2,8(a5)
 92c:	02061593          	slli	a1,a2,0x20
 930:	01c5d713          	srli	a4,a1,0x1c
...
malloc(uint nbytes)
{
 ...
 9b8:	b7e1                	j	980 <malloc+0x36>
      if(p->s.size == nunits)
 9ba:	02e48c63          	beq	s1,a4,9f2 <malloc+0xa8>
        p->s.size -= nunits;
 ...
 9d6:	0aa73b23          	sd	a0,182(a4) # a88 <freep>
      return (void*)(p + 1);
 ...
 9f2:	6398                	ld	a4,0(a5)
 9f4:	e118                	sd	a4,0(a0)
 9f6:	bff1                	j	9d2 <malloc+0x88>
  hp->s.size = nu;
 9f8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));  
 9fc:	0541                	addi	a0,a0,16
 9fe:	00000097          	auipc	ra,0x0
 a02:	ec4080e7          	jalr	-316(ra) # 8c2 <free>
  return freep;
 a06:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0){
 a0a:	d971                	beqz	a0,9de <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 a0c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a0e:	4798                	lw	a4,8(a5)
 a10:	fa9775e3          	bgeu	a4,s1,9ba <malloc+0x70>
    if(p == freep){
 a14:	00093703          	ld	a4,0(s2)
 a18:	853e                	mv	a0,a5
 a1a:	fef719e3          	bne	a4,a5,a0c <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
 a1e:	8552                	mv	a0,s4
 a20:	00000097          	auipc	ra,0x0
 a24:	b74080e7          	jalr	-1164(ra) # 594 <sbrk>
  if(p == (char*)-1)
 a28:	fd5518e3          	bne	a0,s5,9f8 <malloc+0xae>
        return 0;
 a2c:	4501                	li	a0,0
 a2e:	bf45                	j	9de <malloc+0x94>
