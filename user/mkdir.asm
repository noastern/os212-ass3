...
main(int argc, char *argv[])
{
  ...
  42:	7d258593          	addi	a1,a1,2002 # 810 <malloc+0xec>
  46:	4509                	li	a0,2
  ...
  60:	7cc58593          	addi	a1,a1,1996 # 828 <malloc+0x104>
  64:	4509                	li	a0,2
...
0000000000000386 <setAndGetPageFaultsNum>:
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d6:	47e50513          	addi	a0,a0,1150 # 850 <digits>
 3da:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	3b2b8b93          	addi	s7,s7,946 # 850 <digits>
 ...
 5e2:	26a90913          	addi	s2,s2,618 # 848 <malloc+0x124>
        while(*s != 0){
...
free(void *ap)
{
 ...
 6aa:	1c27b783          	ld	a5,450(a5) # 868 <freep>
 ...
 6d8:	00e6ea63          	bltu	a3,a4,6ec <free+0x50>
{
 ...
 71a:	14f73923          	sd	a5,338(a4) # 868 <freep>
}
 71e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 74c:	12053503          	ld	a0,288(a0) # 868 <freep>
 ...
 774:	0f890913          	addi	s2,s2,248 # 868 <freep>
  if(p == (char*)-1)
 778:	5afd                	li	s5,-1
 77a:	a895                	j	7ee <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 77c:	00000797          	auipc	a5,0x0
 780:	0f478793          	addi	a5,a5,244 # 870 <base>
 784:	00000717          	auipc	a4,0x0
 788:	0ef73223          	sd	a5,228(a4) # 868 <freep>
 78c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b0:	0aa73e23          	sd	a0,188(a4) # 868 <freep>
      return (void*)(p + 1);
 ...
 7fe:	b74080e7          	jalr	-1164(ra) # 36e <sbrk>
  if(p == (char*)-1)
